/**
 * RequestInterceptor_Filter302.js - Dynamic HTTP/gRPC Request Interceptor & Outlier Detector
 * Filter Index: 302
 * Part of KubePulse-Mesh Service Mesh Infrastructure
 */

class RequestInterceptor_Filter302 {
  constructor() {
    this.filterId = 'FILTER_302';
    this.headerMutations = { 'x-kubepulse-cluster': 'mesh-node-302', 'x-egress-envoy': 'true' };
...
module.exports = RequestInterceptor_Filter302;
