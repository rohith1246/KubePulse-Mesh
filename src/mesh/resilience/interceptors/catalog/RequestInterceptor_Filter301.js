/**
 * RequestInterceptor_Filter301.js - Dynamic HTTP/gRPC Request Interceptor & Outlier Detector
 * Filter Index: 301
 * Part of KubePulse-Mesh Service Mesh Infrastructure
 */

class RequestInterceptor_Filter301 {
  constructor() {
    this.filterId = 'FILTER_301';
    this.headerMutations = { 'x-kubepulse-cluster': 'mesh-node-301', 'x-egress-envoy': 'true' };
...
module.exports = RequestInterceptor_Filter301;
