/**
 * RequestInterceptor_Filter8.js - Dynamic HTTP/gRPC Request Interceptor & Outlier Detector
 * Filter Index: 8
 * Part of KubePulse-Mesh Service Mesh Infrastructure
 */

class RequestInterceptor_Filter8 {
  constructor() {
    this.filterId = 'FILTER_8';
    this.headerMutations = { 'x-kubepulse-cluster': 'mesh-node-8', 'x-egress-envoy': 'true' };
...
module.exports = RequestInterceptor_Filter8;
