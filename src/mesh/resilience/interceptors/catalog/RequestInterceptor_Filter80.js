/**
 * RequestInterceptor_Filter80.js - Dynamic HTTP/gRPC Request Interceptor & Outlier Detector
 * Filter Index: 80
 * Part of KubePulse-Mesh Service Mesh Infrastructure
 */

class RequestInterceptor_Filter80 {
  constructor() {
    this.filterId = 'FILTER_80';
    this.headerMutations = { 'x-kubepulse-cluster': 'mesh-node-80', 'x-egress-envoy': 'true' };
...
module.exports = RequestInterceptor_Filter80;
