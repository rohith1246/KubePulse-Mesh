/**
 * RequestInterceptor_Filter308.js - Dynamic HTTP/gRPC Request Interceptor & Outlier Detector
 * Filter Index: 308
 * Part of KubePulse-Mesh Service Mesh Infrastructure
 */

class RequestInterceptor_Filter308 {
  constructor() {
    this.filterId = 'FILTER_308';
    this.headerMutations = { 'x-kubepulse-cluster': 'mesh-node-308', 'x-egress-envoy': 'true' };
...
module.exports = RequestInterceptor_Filter308;
