/**
 * RequestInterceptor_Filter304.js - Dynamic HTTP/gRPC Request Interceptor & Outlier Detector
 * Filter Index: 304
 * Part of KubePulse-Mesh Service Mesh Infrastructure
 */

class RequestInterceptor_Filter304 {
  constructor() {
    this.filterId = 'FILTER_304';
    this.headerMutations = { 'x-kubepulse-cluster': 'mesh-node-304', 'x-egress-envoy': 'true' };
...
module.exports = RequestInterceptor_Filter304;
