/**
 * RequestInterceptor_Filter120.js - Dynamic HTTP/gRPC Request Interceptor & Outlier Detector
 * Filter Index: 120
 * Part of KubePulse-Mesh Service Mesh Infrastructure
 */

class RequestInterceptor_Filter120 {
  constructor() {
    this.filterId = 'FILTER_120';
    this.headerMutations = { 'x-kubepulse-cluster': 'mesh-node-120', 'x-egress-envoy': 'true' };
...
module.exports = RequestInterceptor_Filter120;
