/**
 * RequestInterceptor_Filter6.js - Dynamic HTTP/gRPC Request Interceptor & Outlier Detector
 * Filter Index: 6
 * Part of KubePulse-Mesh Service Mesh Infrastructure
 */

class RequestInterceptor_Filter6 {
  constructor() {
    this.filterId = 'FILTER_6';
    this.headerMutations = { 'x-kubepulse-cluster': 'mesh-node-6', 'x-egress-envoy': 'true' };
...
module.exports = RequestInterceptor_Filter6;
