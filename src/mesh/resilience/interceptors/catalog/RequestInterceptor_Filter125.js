/**
 * RequestInterceptor_Filter125.js - Dynamic HTTP/gRPC Request Interceptor & Outlier Detector
 * Filter Index: 125
 * Part of KubePulse-Mesh Service Mesh Infrastructure
 */

class RequestInterceptor_Filter125 {
  constructor() {
    this.filterId = 'FILTER_125';
    this.headerMutations = { 'x-kubepulse-cluster': 'mesh-node-125', 'x-egress-envoy': 'true' };
...
module.exports = RequestInterceptor_Filter125;
