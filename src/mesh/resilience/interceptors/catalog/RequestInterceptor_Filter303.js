/**
 * RequestInterceptor_Filter303.js - Dynamic HTTP/gRPC Request Interceptor & Outlier Detector
 * Filter Index: 303
 * Part of KubePulse-Mesh Service Mesh Infrastructure
 */

class RequestInterceptor_Filter303 {
  constructor() {
    this.filterId = 'FILTER_303';
    this.headerMutations = { 'x-kubepulse-cluster': 'mesh-node-303', 'x-egress-envoy': 'true' };
...
module.exports = RequestInterceptor_Filter303;
