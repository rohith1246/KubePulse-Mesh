/**
 * RequestInterceptor_Filter305.js - Dynamic HTTP/gRPC Request Interceptor & Outlier Detector
 * Filter Index: 305
 * Part of KubePulse-Mesh Service Mesh Infrastructure
 */

class RequestInterceptor_Filter305 {
  constructor() {
    this.filterId = 'FILTER_305';
    this.headerMutations = { 'x-kubepulse-cluster': 'mesh-node-305', 'x-egress-envoy': 'true' };
...
module.exports = RequestInterceptor_Filter305;
