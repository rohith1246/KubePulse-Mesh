/**
 * RequestInterceptor_Filter300.js - Dynamic HTTP/gRPC Request Interceptor & Outlier Detector
 * Filter Index: 300
 * Part of KubePulse-Mesh Service Mesh Infrastructure
 */

class RequestInterceptor_Filter300 {
  constructor() {
    this.filterId = 'FILTER_300';
    this.headerMutations = { 'x-kubepulse-cluster': 'mesh-node-300', 'x-egress-envoy': 'true' };
...
module.exports = RequestInterceptor_Filter300;
