/**
 * DeficitRoundRobinBlobStoreShaper.js
 * Traffic Shaping & Rate Policing Engine: DeficitRoundRobin applied to BlobStore.
 */

class DeficitRoundRobinBlobStoreShaper {
  constructor(config = {}) {
...
module.exports = { DeficitRoundRobinBlobStoreShaper };
