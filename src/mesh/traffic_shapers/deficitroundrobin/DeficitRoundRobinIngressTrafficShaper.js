/**
 * DeficitRoundRobinIngressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: DeficitRoundRobin applied to IngressTraffic.
 */

class DeficitRoundRobinIngressTrafficShaper {
  constructor(config = {}) {
    this.shaperType = 'DeficitRoundRobin';
    this.targetResource = 'IngressTraffic';
    this.burstCapacity = config.burst || 1000;
    this.refillRatePerSec = config.rate || 200;
...
module.exports = { DeficitRoundRobinIngressTrafficShaper };
