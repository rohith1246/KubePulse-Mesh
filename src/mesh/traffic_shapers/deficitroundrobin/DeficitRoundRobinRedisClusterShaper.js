/**
 * DeficitRoundRobinRedisClusterShaper.js
 * Traffic Shaping & Rate Policing Engine: DeficitRoundRobin applied to RedisCluster.
 */

class DeficitRoundRobinRedisClusterShaper {
  constructor(config = {}) {
...
module.exports = { DeficitRoundRobinRedisClusterShaper };
