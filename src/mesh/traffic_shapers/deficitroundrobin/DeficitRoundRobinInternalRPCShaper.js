/**
 * DeficitRoundRobinInternalRPCShaper.js
 * Traffic Shaping & Rate Policing Engine: DeficitRoundRobin applied to InternalRPC.
 */

class DeficitRoundRobinInternalRPCShaper {
  constructor(config = {}) {
...
module.exports = { DeficitRoundRobinInternalRPCShaper };
