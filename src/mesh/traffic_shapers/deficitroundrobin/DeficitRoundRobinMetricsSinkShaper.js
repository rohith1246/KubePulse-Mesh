/**
 * DeficitRoundRobinMetricsSinkShaper.js
 * Traffic Shaping & Rate Policing Engine: DeficitRoundRobin applied to MetricsSink.
 */

class DeficitRoundRobinMetricsSinkShaper {
  constructor(config = {}) {
...
module.exports = { DeficitRoundRobinMetricsSinkShaper };
