/**
 * DeficitRoundRobinDatabasePoolShaper.js
 * Traffic Shaping & Rate Policing Engine: DeficitRoundRobin applied to DatabasePool.
 */

class DeficitRoundRobinDatabasePoolShaper {
  constructor(config = {}) {
...
module.exports = { DeficitRoundRobinDatabasePoolShaper };
