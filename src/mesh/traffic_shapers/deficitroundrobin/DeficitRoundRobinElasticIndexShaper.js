/**
 * DeficitRoundRobinElasticIndexShaper.js
 * Traffic Shaping & Rate Policing Engine: DeficitRoundRobin applied to ElasticIndex.
 */

class DeficitRoundRobinElasticIndexShaper {
  constructor(config = {}) {
...
module.exports = { DeficitRoundRobinElasticIndexShaper };
