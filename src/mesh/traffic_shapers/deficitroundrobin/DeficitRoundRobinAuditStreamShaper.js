/**
 * DeficitRoundRobinAuditStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: DeficitRoundRobin applied to AuditStream.
 */

class DeficitRoundRobinAuditStreamShaper {
  constructor(config = {}) {
...
module.exports = { DeficitRoundRobinAuditStreamShaper };
