/**
 * DeficitRoundRobinEgressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: DeficitRoundRobin applied to EgressTraffic.
 */

class DeficitRoundRobinEgressTrafficShaper {
  constructor(config = {}) {
    this.shaperType = 'DeficitRoundRobin';
    this.targetResource = 'EgressTraffic';
    this.burstCapacity = config.burst || 1050;
...
module.exports = { DeficitRoundRobinEgressTrafficShaper };
