/**
 * DeficitRoundRobinKafkaStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: DeficitRoundRobin applied to KafkaStream.
 */

class DeficitRoundRobinKafkaStreamShaper {
  constructor(config = {}) {
    this.shaperType = 'DeficitRoundRobin';
    this.targetResource = 'KafkaStream';
    this.burstCapacity = config.burst || 1200;
...
module.exports = { DeficitRoundRobinKafkaStreamShaper };
