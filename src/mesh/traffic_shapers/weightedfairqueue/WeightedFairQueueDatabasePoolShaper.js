/**
 * WeightedFairQueueDatabasePoolShaper.js
 * Traffic Shaping & Rate Policing Engine: WeightedFairQueue applied to DatabasePool.
 */

class WeightedFairQueueDatabasePoolShaper {
  constructor(config = {}) {
...
module.exports = { WeightedFairQueueDatabasePoolShaper };
