/**
 * WeightedFairQueueRedisClusterShaper.js
 * Traffic Shaping & Rate Policing Engine: WeightedFairQueue applied to RedisCluster.
 */

class WeightedFairQueueRedisClusterShaper {
  constructor(config = {}) {
...
module.exports = { WeightedFairQueueRedisClusterShaper };
