/**
 * WeightedFairQueueIngressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: WeightedFairQueue applied to IngressTraffic.
 */

class WeightedFairQueueIngressTrafficShaper {
  constructor(config = {}) {
...
module.exports = { WeightedFairQueueIngressTrafficShaper };
