/**
 * WeightedFairQueueInternalRPCShaper.js
 * Traffic Shaping & Rate Policing Engine: WeightedFairQueue applied to InternalRPC.
 */

class WeightedFairQueueInternalRPCShaper {
  constructor(config = {}) {
...
module.exports = { WeightedFairQueueInternalRPCShaper };
