/**
 * WeightedFairQueueEgressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: WeightedFairQueue applied to EgressTraffic.
 */

class WeightedFairQueueEgressTrafficShaper {
  constructor(config = {}) {
...
module.exports = { WeightedFairQueueEgressTrafficShaper };
