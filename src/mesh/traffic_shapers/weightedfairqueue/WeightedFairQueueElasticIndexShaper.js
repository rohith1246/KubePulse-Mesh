/**
 * WeightedFairQueueElasticIndexShaper.js
 * Traffic Shaping & Rate Policing Engine: WeightedFairQueue applied to ElasticIndex.
 */

class WeightedFairQueueElasticIndexShaper {
  constructor(config = {}) {
...
module.exports = { WeightedFairQueueElasticIndexShaper };
