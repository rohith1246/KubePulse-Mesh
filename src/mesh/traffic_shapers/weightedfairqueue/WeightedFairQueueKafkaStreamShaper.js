/**
 * WeightedFairQueueKafkaStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: WeightedFairQueue applied to KafkaStream.
 */

class WeightedFairQueueKafkaStreamShaper {
  constructor(config = {}) {
...
module.exports = { WeightedFairQueueKafkaStreamShaper };
