/**
 * WeightedFairQueueMetricsSinkShaper.js
 * Traffic Shaping & Rate Policing Engine: WeightedFairQueue applied to MetricsSink.
 */

class WeightedFairQueueMetricsSinkShaper {
  constructor(config = {}) {
...
module.exports = { WeightedFairQueueMetricsSinkShaper };
