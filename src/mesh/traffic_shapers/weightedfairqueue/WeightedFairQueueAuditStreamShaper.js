/**
 * WeightedFairQueueAuditStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: WeightedFairQueue applied to AuditStream.
 */

class WeightedFairQueueAuditStreamShaper {
  constructor(config = {}) {
...
module.exports = { WeightedFairQueueAuditStreamShaper };
