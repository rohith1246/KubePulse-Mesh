/**
 * TokenBucketRateElasticIndexShaper.js
 * Traffic Shaping & Rate Policing Engine: TokenBucketRate applied to ElasticIndex.
 */

class TokenBucketRateElasticIndexShaper {
  constructor(config = {}) {
...
module.exports = { TokenBucketRateElasticIndexShaper };
