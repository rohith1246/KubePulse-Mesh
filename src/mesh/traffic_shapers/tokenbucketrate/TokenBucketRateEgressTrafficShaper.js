/**
 * TokenBucketRateEgressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: TokenBucketRate applied to EgressTraffic.
 */

class TokenBucketRateEgressTrafficShaper {
  constructor(config = {}) {
...
module.exports = { TokenBucketRateEgressTrafficShaper };
