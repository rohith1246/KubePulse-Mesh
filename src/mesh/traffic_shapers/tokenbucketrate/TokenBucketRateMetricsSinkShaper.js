/**
 * TokenBucketRateMetricsSinkShaper.js
 * Traffic Shaping & Rate Policing Engine: TokenBucketRate applied to MetricsSink.
 */

class TokenBucketRateMetricsSinkShaper {
  constructor(config = {}) {
...
module.exports = { TokenBucketRateMetricsSinkShaper };
