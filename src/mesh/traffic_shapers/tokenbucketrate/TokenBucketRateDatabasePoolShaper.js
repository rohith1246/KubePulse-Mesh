/**
 * TokenBucketRateDatabasePoolShaper.js
 * Traffic Shaping & Rate Policing Engine: TokenBucketRate applied to DatabasePool.
 */

class TokenBucketRateDatabasePoolShaper {
  constructor(config = {}) {
...
module.exports = { TokenBucketRateDatabasePoolShaper };
