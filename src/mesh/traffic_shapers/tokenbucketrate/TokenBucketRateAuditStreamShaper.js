/**
 * TokenBucketRateAuditStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: TokenBucketRate applied to AuditStream.
 */

class TokenBucketRateAuditStreamShaper {
  constructor(config = {}) {
...
module.exports = { TokenBucketRateAuditStreamShaper };
