/**
 * TokenBucketRateIngressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: TokenBucketRate applied to IngressTraffic.
 */

class TokenBucketRateIngressTrafficShaper {
  constructor(config = {}) {
    this.shaperType = 'TokenBucketRate';
    this.targetResource = 'IngressTraffic';
    this.burstCapacity = config.burst || 600;
    this.refillRatePerSec = config.rate || 120;
...
module.exports = { TokenBucketRateIngressTrafficShaper };
