/**
 * TokenBucketRateBlobStoreShaper.js
 * Traffic Shaping & Rate Policing Engine: TokenBucketRate applied to BlobStore.
 */

class TokenBucketRateBlobStoreShaper {
  constructor(config = {}) {
...
module.exports = { TokenBucketRateBlobStoreShaper };
