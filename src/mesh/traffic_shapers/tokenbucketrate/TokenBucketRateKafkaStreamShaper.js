/**
 * TokenBucketRateKafkaStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: TokenBucketRate applied to KafkaStream.
 */

class TokenBucketRateKafkaStreamShaper {
  constructor(config = {}) {
...
module.exports = { TokenBucketRateKafkaStreamShaper };
