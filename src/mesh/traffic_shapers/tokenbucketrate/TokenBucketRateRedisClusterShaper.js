/**
 * TokenBucketRateRedisClusterShaper.js
 * Traffic Shaping & Rate Policing Engine: TokenBucketRate applied to RedisCluster.
 */

class TokenBucketRateRedisClusterShaper {
  constructor(config = {}) {
...
module.exports = { TokenBucketRateRedisClusterShaper };
