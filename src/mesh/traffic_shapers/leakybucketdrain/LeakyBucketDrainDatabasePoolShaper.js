/**
 * LeakyBucketDrainDatabasePoolShaper.js
 * Traffic Shaping & Rate Policing Engine: LeakyBucketDrain applied to DatabasePool.
 */

class LeakyBucketDrainDatabasePoolShaper {
  constructor(config = {}) {
    this.shaperType = 'LeakyBucketDrain';
    this.targetResource = 'DatabasePool';
    this.burstCapacity = config.burst || 850;
...
module.exports = { LeakyBucketDrainDatabasePoolShaper };
