/**
 * LeakyBucketDrainKafkaStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: LeakyBucketDrain applied to KafkaStream.
 */

class LeakyBucketDrainKafkaStreamShaper {
  constructor(config = {}) {
...
module.exports = { LeakyBucketDrainKafkaStreamShaper };
