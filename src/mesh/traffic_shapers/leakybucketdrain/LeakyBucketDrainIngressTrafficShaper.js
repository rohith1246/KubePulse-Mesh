/**
 * LeakyBucketDrainIngressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: LeakyBucketDrain applied to IngressTraffic.
 */

class LeakyBucketDrainIngressTrafficShaper {
  constructor(config = {}) {
    this.shaperType = 'LeakyBucketDrain';
    this.targetResource = 'IngressTraffic';
    this.burstCapacity = config.burst || 700;
    this.refillRatePerSec = config.rate || 140;
...
module.exports = { LeakyBucketDrainIngressTrafficShaper };
