/**
 * LeakyBucketDrainRedisClusterShaper.js
 * Traffic Shaping & Rate Policing Engine: LeakyBucketDrain applied to RedisCluster.
 */

class LeakyBucketDrainRedisClusterShaper {
  constructor(config = {}) {
    this.shaperType = 'LeakyBucketDrain';
    this.targetResource = 'RedisCluster';
    this.burstCapacity = config.burst || 950;
...
module.exports = { LeakyBucketDrainRedisClusterShaper };
