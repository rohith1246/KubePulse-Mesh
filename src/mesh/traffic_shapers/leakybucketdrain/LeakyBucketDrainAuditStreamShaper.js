/**
 * LeakyBucketDrainAuditStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: LeakyBucketDrain applied to AuditStream.
 */

class LeakyBucketDrainAuditStreamShaper {
  constructor(config = {}) {
...
module.exports = { LeakyBucketDrainAuditStreamShaper };
