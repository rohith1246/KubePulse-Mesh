/**
 * LeakyBucketDrainMetricsSinkShaper.js
 * Traffic Shaping & Rate Policing Engine: LeakyBucketDrain applied to MetricsSink.
 */

class LeakyBucketDrainMetricsSinkShaper {
  constructor(config = {}) {
...
module.exports = { LeakyBucketDrainMetricsSinkShaper };
