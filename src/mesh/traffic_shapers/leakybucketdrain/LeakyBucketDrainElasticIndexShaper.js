/**
 * LeakyBucketDrainElasticIndexShaper.js
 * Traffic Shaping & Rate Policing Engine: LeakyBucketDrain applied to ElasticIndex.
 */

class LeakyBucketDrainElasticIndexShaper {
  constructor(config = {}) {
...
module.exports = { LeakyBucketDrainElasticIndexShaper };
