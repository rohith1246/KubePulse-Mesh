/**
 * LeakyBucketDrainEgressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: LeakyBucketDrain applied to EgressTraffic.
 */

class LeakyBucketDrainEgressTrafficShaper {
  constructor(config = {}) {
...
module.exports = { LeakyBucketDrainEgressTrafficShaper };
