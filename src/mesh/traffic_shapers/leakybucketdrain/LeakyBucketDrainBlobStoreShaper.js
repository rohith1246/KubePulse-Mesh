/**
 * LeakyBucketDrainBlobStoreShaper.js
 * Traffic Shaping & Rate Policing Engine: LeakyBucketDrain applied to BlobStore.
 */

class LeakyBucketDrainBlobStoreShaper {
  constructor(config = {}) {
...
module.exports = { LeakyBucketDrainBlobStoreShaper };
