/**
 * LeakyBucketDrainInternalRPCShaper.js
 * Traffic Shaping & Rate Policing Engine: LeakyBucketDrain applied to InternalRPC.
 */

class LeakyBucketDrainInternalRPCShaper {
  constructor(config = {}) {
...
module.exports = { LeakyBucketDrainInternalRPCShaper };
