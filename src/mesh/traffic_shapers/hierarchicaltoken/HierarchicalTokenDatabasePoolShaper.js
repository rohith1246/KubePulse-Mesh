/**
 * HierarchicalTokenDatabasePoolShaper.js
 * Traffic Shaping & Rate Policing Engine: HierarchicalToken applied to DatabasePool.
 */

class HierarchicalTokenDatabasePoolShaper {
  constructor(config = {}) {
    this.shaperType = 'HierarchicalToken';
    this.targetResource = 'DatabasePool';
...
module.exports = { HierarchicalTokenDatabasePoolShaper };
