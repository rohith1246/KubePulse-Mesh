/**
 * HierarchicalTokenEgressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: HierarchicalToken applied to EgressTraffic.
 */

class HierarchicalTokenEgressTrafficShaper {
  constructor(config = {}) {
    this.shaperType = 'HierarchicalToken';
    this.targetResource = 'EgressTraffic';
    this.burstCapacity = config.burst || 1450;
...
module.exports = { HierarchicalTokenEgressTrafficShaper };
