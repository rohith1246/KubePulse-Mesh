/**
 * HierarchicalTokenMetricsSinkShaper.js
 * Traffic Shaping & Rate Policing Engine: HierarchicalToken applied to MetricsSink.
 */

class HierarchicalTokenMetricsSinkShaper {
  constructor(config = {}) {
    this.shaperType = 'HierarchicalToken';
    this.targetResource = 'MetricsSink';
    this.burstCapacity = config.burst || 1800;
...
module.exports = { HierarchicalTokenMetricsSinkShaper };
