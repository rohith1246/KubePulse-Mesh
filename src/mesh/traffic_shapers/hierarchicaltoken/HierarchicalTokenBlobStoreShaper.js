/**
 * HierarchicalTokenBlobStoreShaper.js
 * Traffic Shaping & Rate Policing Engine: HierarchicalToken applied to BlobStore.
 */

class HierarchicalTokenBlobStoreShaper {
  constructor(config = {}) {
...
module.exports = { HierarchicalTokenBlobStoreShaper };
