/**
 * HierarchicalTokenAuditStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: HierarchicalToken applied to AuditStream.
 */

class HierarchicalTokenAuditStreamShaper {
  constructor(config = {}) {
    this.shaperType = 'HierarchicalToken';
    this.targetResource = 'AuditStream';
    this.burstCapacity = config.burst || 1850;
...
module.exports = { HierarchicalTokenAuditStreamShaper };
