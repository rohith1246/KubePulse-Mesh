/**
 * HierarchicalTokenRedisClusterShaper.js
 * Traffic Shaping & Rate Policing Engine: HierarchicalToken applied to RedisCluster.
 */

class HierarchicalTokenRedisClusterShaper {
  constructor(config = {}) {
    this.shaperType = 'HierarchicalToken';
    this.targetResource = 'RedisCluster';
    this.burstCapacity = config.burst || 1650;
...
module.exports = { HierarchicalTokenRedisClusterShaper };
