/**
 * HierarchicalTokenIngressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: HierarchicalToken applied to IngressTraffic.
 */

class HierarchicalTokenIngressTrafficShaper {
  constructor(config = {}) {
    this.shaperType = 'HierarchicalToken';
    this.targetResource = 'IngressTraffic';
    this.burstCapacity = config.burst || 1400;
    this.refillRatePerSec = config.rate || 280;
...
module.exports = { HierarchicalTokenIngressTrafficShaper };
