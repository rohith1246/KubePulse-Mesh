/**
 * HierarchicalTokenElasticIndexShaper.js
 * Traffic Shaping & Rate Policing Engine: HierarchicalToken applied to ElasticIndex.
 */

class HierarchicalTokenElasticIndexShaper {
  constructor(config = {}) {
    this.shaperType = 'HierarchicalToken';
    this.targetResource = 'ElasticIndex';
    this.burstCapacity = config.burst || 1700;
...
module.exports = { HierarchicalTokenElasticIndexShaper };
