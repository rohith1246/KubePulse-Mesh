/**
 * HierarchicalTokenInternalRPCShaper.js
 * Traffic Shaping & Rate Policing Engine: HierarchicalToken applied to InternalRPC.
 */

class HierarchicalTokenInternalRPCShaper {
  constructor(config = {}) {
...
module.exports = { HierarchicalTokenInternalRPCShaper };
