/**
 * HierarchicalTokenKafkaStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: HierarchicalToken applied to KafkaStream.
 */

class HierarchicalTokenKafkaStreamShaper {
  constructor(config = {}) {
    this.shaperType = 'HierarchicalToken';
    this.targetResource = 'KafkaStream';
    this.burstCapacity = config.burst || 1600;
...
module.exports = { HierarchicalTokenKafkaStreamShaper };
