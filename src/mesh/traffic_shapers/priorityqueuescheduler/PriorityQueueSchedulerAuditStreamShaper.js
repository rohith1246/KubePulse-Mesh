/**
 * PriorityQueueSchedulerAuditStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: PriorityQueueScheduler applied to AuditStream.
 */

class PriorityQueueSchedulerAuditStreamShaper {
  constructor(config = {}) {
...
module.exports = { PriorityQueueSchedulerAuditStreamShaper };
