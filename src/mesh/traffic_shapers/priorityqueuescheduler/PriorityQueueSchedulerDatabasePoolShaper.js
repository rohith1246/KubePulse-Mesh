/**
 * PriorityQueueSchedulerDatabasePoolShaper.js
 * Traffic Shaping & Rate Policing Engine: PriorityQueueScheduler applied to DatabasePool.
 */

class PriorityQueueSchedulerDatabasePoolShaper {
  constructor(config = {}) {
...
module.exports = { PriorityQueueSchedulerDatabasePoolShaper };
