/**
 * PriorityQueueSchedulerElasticIndexShaper.js
 * Traffic Shaping & Rate Policing Engine: PriorityQueueScheduler applied to ElasticIndex.
 */

class PriorityQueueSchedulerElasticIndexShaper {
  constructor(config = {}) {
...
module.exports = { PriorityQueueSchedulerElasticIndexShaper };
