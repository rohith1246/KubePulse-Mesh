/**
 * PriorityQueueSchedulerMetricsSinkShaper.js
 * Traffic Shaping & Rate Policing Engine: PriorityQueueScheduler applied to MetricsSink.
 */

class PriorityQueueSchedulerMetricsSinkShaper {
  constructor(config = {}) {
...
module.exports = { PriorityQueueSchedulerMetricsSinkShaper };
