/**
 * PriorityQueueSchedulerRedisClusterShaper.js
 * Traffic Shaping & Rate Policing Engine: PriorityQueueScheduler applied to RedisCluster.
 */

class PriorityQueueSchedulerRedisClusterShaper {
  constructor(config = {}) {
...
module.exports = { PriorityQueueSchedulerRedisClusterShaper };
