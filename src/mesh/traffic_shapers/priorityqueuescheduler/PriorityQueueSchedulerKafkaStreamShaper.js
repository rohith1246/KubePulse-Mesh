/**
 * PriorityQueueSchedulerKafkaStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: PriorityQueueScheduler applied to KafkaStream.
 */

class PriorityQueueSchedulerKafkaStreamShaper {
  constructor(config = {}) {
...
module.exports = { PriorityQueueSchedulerKafkaStreamShaper };
