/**
 * PriorityQueueSchedulerEgressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: PriorityQueueScheduler applied to EgressTraffic.
 */

class PriorityQueueSchedulerEgressTrafficShaper {
  constructor(config = {}) {
...
module.exports = { PriorityQueueSchedulerEgressTrafficShaper };
