/**
 * PriorityQueueSchedulerIngressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: PriorityQueueScheduler applied to IngressTraffic.
 */

class PriorityQueueSchedulerIngressTrafficShaper {
  constructor(config = {}) {
...
module.exports = { PriorityQueueSchedulerIngressTrafficShaper };
