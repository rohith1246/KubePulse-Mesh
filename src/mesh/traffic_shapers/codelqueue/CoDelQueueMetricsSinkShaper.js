/**
 * CoDelQueueMetricsSinkShaper.js
 * Traffic Shaping & Rate Policing Engine: CoDelQueue applied to MetricsSink.
 */

class CoDelQueueMetricsSinkShaper {
  constructor(config = {}) {
...
module.exports = { CoDelQueueMetricsSinkShaper };
