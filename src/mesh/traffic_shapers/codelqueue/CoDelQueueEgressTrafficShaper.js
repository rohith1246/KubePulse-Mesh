/**
 * CoDelQueueEgressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: CoDelQueue applied to EgressTraffic.
 */

class CoDelQueueEgressTrafficShaper {
  constructor(config = {}) {
...
module.exports = { CoDelQueueEgressTrafficShaper };
