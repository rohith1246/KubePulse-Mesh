/**
 * CoDelQueueKafkaStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: CoDelQueue applied to KafkaStream.
 */

class CoDelQueueKafkaStreamShaper {
  constructor(config = {}) {
...
module.exports = { CoDelQueueKafkaStreamShaper };
