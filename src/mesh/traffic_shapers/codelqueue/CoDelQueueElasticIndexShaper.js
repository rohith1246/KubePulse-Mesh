/**
 * CoDelQueueElasticIndexShaper.js
 * Traffic Shaping & Rate Policing Engine: CoDelQueue applied to ElasticIndex.
 */

class CoDelQueueElasticIndexShaper {
  constructor(config = {}) {
...
module.exports = { CoDelQueueElasticIndexShaper };
