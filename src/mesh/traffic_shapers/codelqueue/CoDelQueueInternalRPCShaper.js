/**
 * CoDelQueueInternalRPCShaper.js
 * Traffic Shaping & Rate Policing Engine: CoDelQueue applied to InternalRPC.
 */

class CoDelQueueInternalRPCShaper {
  constructor(config = {}) {
...
module.exports = { CoDelQueueInternalRPCShaper };
