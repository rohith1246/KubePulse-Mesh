/**
 * CoDelQueueDatabasePoolShaper.js
 * Traffic Shaping & Rate Policing Engine: CoDelQueue applied to DatabasePool.
 */

class CoDelQueueDatabasePoolShaper {
  constructor(config = {}) {
...
module.exports = { CoDelQueueDatabasePoolShaper };
