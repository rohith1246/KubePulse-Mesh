/**
 * CoDelQueueAuditStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: CoDelQueue applied to AuditStream.
 */

class CoDelQueueAuditStreamShaper {
  constructor(config = {}) {
...
module.exports = { CoDelQueueAuditStreamShaper };
