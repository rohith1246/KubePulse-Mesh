/**
 * CoDelQueueBlobStoreShaper.js
 * Traffic Shaping & Rate Policing Engine: CoDelQueue applied to BlobStore.
 */

class CoDelQueueBlobStoreShaper {
  constructor(config = {}) {
...
module.exports = { CoDelQueueBlobStoreShaper };
