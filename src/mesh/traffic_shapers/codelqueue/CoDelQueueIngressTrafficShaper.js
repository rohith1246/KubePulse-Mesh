/**
 * CoDelQueueIngressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: CoDelQueue applied to IngressTraffic.
 */

class CoDelQueueIngressTrafficShaper {
  constructor(config = {}) {
    this.shaperType = 'CoDelQueue';
    this.targetResource = 'IngressTraffic';
    this.burstCapacity = config.burst || 1200;
    this.refillRatePerSec = config.rate || 240;
...
module.exports = { CoDelQueueIngressTrafficShaper };
