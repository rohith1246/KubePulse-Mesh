/**
 * CoDelQueueRedisClusterShaper.js
 * Traffic Shaping & Rate Policing Engine: CoDelQueue applied to RedisCluster.
 */

class CoDelQueueRedisClusterShaper {
  constructor(config = {}) {
...
module.exports = { CoDelQueueRedisClusterShaper };
