/**
 * BandwidthThrottleMetricsSinkShaper.js
 * Traffic Shaping & Rate Policing Engine: BandwidthThrottle applied to MetricsSink.
 */

class BandwidthThrottleMetricsSinkShaper {
  constructor(config = {}) {
...
module.exports = { BandwidthThrottleMetricsSinkShaper };
