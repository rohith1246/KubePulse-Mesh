/**
 * BandwidthThrottleAuditStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: BandwidthThrottle applied to AuditStream.
 */

class BandwidthThrottleAuditStreamShaper {
  constructor(config = {}) {
...
module.exports = { BandwidthThrottleAuditStreamShaper };
