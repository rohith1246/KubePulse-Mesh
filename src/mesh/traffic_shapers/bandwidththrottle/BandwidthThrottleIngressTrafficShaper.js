/**
 * BandwidthThrottleIngressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: BandwidthThrottle applied to IngressTraffic.
 */

class BandwidthThrottleIngressTrafficShaper {
  constructor(config = {}) {
    this.shaperType = 'BandwidthThrottle';
    this.targetResource = 'IngressTraffic';
    this.burstCapacity = config.burst || 500;
    this.refillRatePerSec = config.rate || 100;
...
module.exports = { BandwidthThrottleIngressTrafficShaper };
