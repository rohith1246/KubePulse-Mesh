/**
 * BandwidthThrottleDatabasePoolShaper.js
 * Traffic Shaping & Rate Policing Engine: BandwidthThrottle applied to DatabasePool.
 */

class BandwidthThrottleDatabasePoolShaper {
  constructor(config = {}) {
    this.shaperType = 'BandwidthThrottle';
    this.targetResource = 'DatabasePool';
    this.burstCapacity = config.burst || 650;
...
module.exports = { BandwidthThrottleDatabasePoolShaper };
