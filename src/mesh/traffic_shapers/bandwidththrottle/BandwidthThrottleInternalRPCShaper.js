/**
 * BandwidthThrottleInternalRPCShaper.js
 * Traffic Shaping & Rate Policing Engine: BandwidthThrottle applied to InternalRPC.
 */

class BandwidthThrottleInternalRPCShaper {
  constructor(config = {}) {
...
module.exports = { BandwidthThrottleInternalRPCShaper };
