/**
 * BandwidthThrottleElasticIndexShaper.js
 * Traffic Shaping & Rate Policing Engine: BandwidthThrottle applied to ElasticIndex.
 */

class BandwidthThrottleElasticIndexShaper {
  constructor(config = {}) {
    this.shaperType = 'BandwidthThrottle';
    this.targetResource = 'ElasticIndex';
    this.burstCapacity = config.burst || 800;
...
module.exports = { BandwidthThrottleElasticIndexShaper };
