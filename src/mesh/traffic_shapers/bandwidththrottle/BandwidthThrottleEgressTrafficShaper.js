/**
 * BandwidthThrottleEgressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: BandwidthThrottle applied to EgressTraffic.
 */

class BandwidthThrottleEgressTrafficShaper {
  constructor(config = {}) {
    this.shaperType = 'BandwidthThrottle';
    this.targetResource = 'EgressTraffic';
    this.burstCapacity = config.burst || 550;
...
module.exports = { BandwidthThrottleEgressTrafficShaper };
