/**
 * BandwidthThrottleRedisClusterShaper.js
 * Traffic Shaping & Rate Policing Engine: BandwidthThrottle applied to RedisCluster.
 */

class BandwidthThrottleRedisClusterShaper {
  constructor(config = {}) {
    this.shaperType = 'BandwidthThrottle';
    this.targetResource = 'RedisCluster';
    this.burstCapacity = config.burst || 750;
...
module.exports = { BandwidthThrottleRedisClusterShaper };
