/**
 * BandwidthThrottleKafkaStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: BandwidthThrottle applied to KafkaStream.
 */

class BandwidthThrottleKafkaStreamShaper {
  constructor(config = {}) {
...
module.exports = { BandwidthThrottleKafkaStreamShaper };
