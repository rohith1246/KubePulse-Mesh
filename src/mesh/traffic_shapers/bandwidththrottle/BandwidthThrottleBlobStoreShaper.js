/**
 * BandwidthThrottleBlobStoreShaper.js
 * Traffic Shaping & Rate Policing Engine: BandwidthThrottle applied to BlobStore.
 */

class BandwidthThrottleBlobStoreShaper {
  constructor(config = {}) {
...
module.exports = { BandwidthThrottleBlobStoreShaper };
