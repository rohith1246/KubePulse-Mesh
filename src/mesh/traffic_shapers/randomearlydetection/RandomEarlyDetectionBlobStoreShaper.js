/**
 * RandomEarlyDetectionBlobStoreShaper.js
 * Traffic Shaping & Rate Policing Engine: RandomEarlyDetection applied to BlobStore.
 */

class RandomEarlyDetectionBlobStoreShaper {
  constructor(config = {}) {
...
module.exports = { RandomEarlyDetectionBlobStoreShaper };
