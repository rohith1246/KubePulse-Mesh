/**
 * RandomEarlyDetectionKafkaStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: RandomEarlyDetection applied to KafkaStream.
 */

class RandomEarlyDetectionKafkaStreamShaper {
  constructor(config = {}) {
    this.shaperType = 'RandomEarlyDetection';
    this.targetResource = 'KafkaStream';
    this.burstCapacity = config.burst || 1300;
...
module.exports = { RandomEarlyDetectionKafkaStreamShaper };
