/**
 * RandomEarlyDetectionDatabasePoolShaper.js
 * Traffic Shaping & Rate Policing Engine: RandomEarlyDetection applied to DatabasePool.
 */

class RandomEarlyDetectionDatabasePoolShaper {
  constructor(config = {}) {
...
module.exports = { RandomEarlyDetectionDatabasePoolShaper };
