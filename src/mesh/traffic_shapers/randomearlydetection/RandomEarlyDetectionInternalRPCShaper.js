/**
 * RandomEarlyDetectionInternalRPCShaper.js
 * Traffic Shaping & Rate Policing Engine: RandomEarlyDetection applied to InternalRPC.
 */

class RandomEarlyDetectionInternalRPCShaper {
  constructor(config = {}) {
...
module.exports = { RandomEarlyDetectionInternalRPCShaper };
