/**
 * RandomEarlyDetectionRedisClusterShaper.js
 * Traffic Shaping & Rate Policing Engine: RandomEarlyDetection applied to RedisCluster.
 */

class RandomEarlyDetectionRedisClusterShaper {
  constructor(config = {}) {
    this.shaperType = 'RandomEarlyDetection';
    this.targetResource = 'RedisCluster';
    this.burstCapacity = config.burst || 1350;
...
module.exports = { RandomEarlyDetectionRedisClusterShaper };
