/**
 * RandomEarlyDetectionAuditStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: RandomEarlyDetection applied to AuditStream.
 */

class RandomEarlyDetectionAuditStreamShaper {
  constructor(config = {}) {
    this.shaperType = 'RandomEarlyDetection';
    this.targetResource = 'AuditStream';
    this.burstCapacity = config.burst || 1550;
...
module.exports = { RandomEarlyDetectionAuditStreamShaper };
