/**
 * RandomEarlyDetectionMetricsSinkShaper.js
 * Traffic Shaping & Rate Policing Engine: RandomEarlyDetection applied to MetricsSink.
 */

class RandomEarlyDetectionMetricsSinkShaper {
  constructor(config = {}) {
    this.shaperType = 'RandomEarlyDetection';
    this.targetResource = 'MetricsSink';
    this.burstCapacity = config.burst || 1500;
...
module.exports = { RandomEarlyDetectionMetricsSinkShaper };
