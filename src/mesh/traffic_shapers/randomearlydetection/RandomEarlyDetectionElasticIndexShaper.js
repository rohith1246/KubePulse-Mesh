/**
 * RandomEarlyDetectionElasticIndexShaper.js
 * Traffic Shaping & Rate Policing Engine: RandomEarlyDetection applied to ElasticIndex.
 */

class RandomEarlyDetectionElasticIndexShaper {
  constructor(config = {}) {
    this.shaperType = 'RandomEarlyDetection';
    this.targetResource = 'ElasticIndex';
    this.burstCapacity = config.burst || 1400;
...
module.exports = { RandomEarlyDetectionElasticIndexShaper };
