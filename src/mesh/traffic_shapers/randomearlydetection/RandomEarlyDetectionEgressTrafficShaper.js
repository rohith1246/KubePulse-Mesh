/**
 * RandomEarlyDetectionEgressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: RandomEarlyDetection applied to EgressTraffic.
 */

class RandomEarlyDetectionEgressTrafficShaper {
  constructor(config = {}) {
    this.shaperType = 'RandomEarlyDetection';
    this.targetResource = 'EgressTraffic';
    this.burstCapacity = config.burst || 1150;
...
module.exports = { RandomEarlyDetectionEgressTrafficShaper };
