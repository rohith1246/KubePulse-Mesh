/**
 * RandomEarlyDetectionIngressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: RandomEarlyDetection applied to IngressTraffic.
 */

class RandomEarlyDetectionIngressTrafficShaper {
  constructor(config = {}) {
    this.shaperType = 'RandomEarlyDetection';
    this.targetResource = 'IngressTraffic';
    this.burstCapacity = config.burst || 1100;
    this.refillRatePerSec = config.rate || 220;
...
module.exports = { RandomEarlyDetectionIngressTrafficShaper };
