/**
 * FQCoDelSchedulerEgressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: FQCoDelScheduler applied to EgressTraffic.
 */

class FQCoDelSchedulerEgressTrafficShaper {
  constructor(config = {}) {
...
module.exports = { FQCoDelSchedulerEgressTrafficShaper };
