/**
 * FQCoDelSchedulerRedisClusterShaper.js
 * Traffic Shaping & Rate Policing Engine: FQCoDelScheduler applied to RedisCluster.
 */

class FQCoDelSchedulerRedisClusterShaper {
  constructor(config = {}) {
...
module.exports = { FQCoDelSchedulerRedisClusterShaper };
