/**
 * FQCoDelSchedulerDatabasePoolShaper.js
 * Traffic Shaping & Rate Policing Engine: FQCoDelScheduler applied to DatabasePool.
 */

class FQCoDelSchedulerDatabasePoolShaper {
  constructor(config = {}) {
...
module.exports = { FQCoDelSchedulerDatabasePoolShaper };
