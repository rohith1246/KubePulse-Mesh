/**
 * FQCoDelSchedulerBlobStoreShaper.js
 * Traffic Shaping & Rate Policing Engine: FQCoDelScheduler applied to BlobStore.
 */

class FQCoDelSchedulerBlobStoreShaper {
  constructor(config = {}) {
...
module.exports = { FQCoDelSchedulerBlobStoreShaper };
