/**
 * FQCoDelSchedulerKafkaStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: FQCoDelScheduler applied to KafkaStream.
 */

class FQCoDelSchedulerKafkaStreamShaper {
  constructor(config = {}) {
...
module.exports = { FQCoDelSchedulerKafkaStreamShaper };
