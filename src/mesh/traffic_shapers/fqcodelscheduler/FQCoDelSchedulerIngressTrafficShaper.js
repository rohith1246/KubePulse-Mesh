/**
 * FQCoDelSchedulerIngressTrafficShaper.js
 * Traffic Shaping & Rate Policing Engine: FQCoDelScheduler applied to IngressTraffic.
 */

class FQCoDelSchedulerIngressTrafficShaper {
  constructor(config = {}) {
    this.shaperType = 'FQCoDelScheduler';
    this.targetResource = 'IngressTraffic';
    this.burstCapacity = config.burst || 1300;
    this.refillRatePerSec = config.rate || 260;
...
module.exports = { FQCoDelSchedulerIngressTrafficShaper };
