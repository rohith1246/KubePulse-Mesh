/**
 * FQCoDelSchedulerInternalRPCShaper.js
 * Traffic Shaping & Rate Policing Engine: FQCoDelScheduler applied to InternalRPC.
 */

class FQCoDelSchedulerInternalRPCShaper {
  constructor(config = {}) {
...
module.exports = { FQCoDelSchedulerInternalRPCShaper };
