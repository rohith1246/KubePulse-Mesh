/**
 * FQCoDelSchedulerAuditStreamShaper.js
 * Traffic Shaping & Rate Policing Engine: FQCoDelScheduler applied to AuditStream.
 */

class FQCoDelSchedulerAuditStreamShaper {
  constructor(config = {}) {
    this.shaperType = 'FQCoDelScheduler';
    this.targetResource = 'AuditStream';
    this.burstCapacity = config.burst || 1750;
...
module.exports = { FQCoDelSchedulerAuditStreamShaper };
