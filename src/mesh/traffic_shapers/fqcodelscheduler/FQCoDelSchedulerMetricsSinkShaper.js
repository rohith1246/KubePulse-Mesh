/**
 * FQCoDelSchedulerMetricsSinkShaper.js
 * Traffic Shaping & Rate Policing Engine: FQCoDelScheduler applied to MetricsSink.
 */

class FQCoDelSchedulerMetricsSinkShaper {
  constructor(config = {}) {
...
module.exports = { FQCoDelSchedulerMetricsSinkShaper };
