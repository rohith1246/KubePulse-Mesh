/**
 * FQCoDelSchedulerElasticIndexShaper.js
 * Traffic Shaping & Rate Policing Engine: FQCoDelScheduler applied to ElasticIndex.
 */

class FQCoDelSchedulerElasticIndexShaper {
  constructor(config = {}) {
...
module.exports = { FQCoDelSchedulerElasticIndexShaper };
