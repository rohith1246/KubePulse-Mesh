/**
 * SecurityPolicy_RuleSet_125.js - Zero Trust Network Security Policy Engine
 * RuleSet ID: 125
 * Part of KubePulse-Mesh Service Mesh Infrastructure
 */

class SecurityPolicy_RuleSet_125 {
  constructor(allowedRoles = ['admin', 'service-account-125']) {
    this.ruleSetId = 'SEC_POLICY_125';
    this.allowedRoles = new Set(allowedRoles);
    this.rateLimitPerMin = 625;
...
module.exports = SecurityPolicy_RuleSet_125;
