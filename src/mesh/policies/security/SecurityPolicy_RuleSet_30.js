/**
 * SecurityPolicy_RuleSet_30.js - Zero Trust Network Security Policy Engine
 * RuleSet ID: 30
 * Part of KubePulse-Mesh Service Mesh Infrastructure
 */

class SecurityPolicy_RuleSet_30 {
  constructor(allowedRoles = ['admin', 'service-account-30']) {
    this.ruleSetId = 'SEC_POLICY_30';
    this.allowedRoles = new Set(allowedRoles);
    this.rateLimitPerMin = 530;
...
module.exports = SecurityPolicy_RuleSet_30;
