/**
 * ZeroTrustSearchClusterPolicy.js
 * Service Mesh Security & Routing Policy: ZeroTrust applied to SearchCluster.
 */

class ZeroTrustSearchClusterPolicy {
...
module.exports = { ZeroTrustSearchClusterPolicy };
