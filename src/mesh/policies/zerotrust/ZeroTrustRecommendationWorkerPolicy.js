/**
 * ZeroTrustRecommendationWorkerPolicy.js
 * Service Mesh Security & Routing Policy: ZeroTrust applied to RecommendationWorker.
 */

class ZeroTrustRecommendationWorkerPolicy {
  constructor(policyConfig = {}) {
    this.policyName = 'ZeroTrust';
    this.targetService = 'RecommendationWorker';
    this.enforceStrict = policyConfig.strict !== undefined ? policyConfig.strict : true;
    this.maxRps = policyConfig.maxRps || 2050;
...
module.exports = { ZeroTrustRecommendationWorkerPolicy };
