/**
 * ZeroTrustNotificationStreamPolicy.js
 * Service Mesh Security & Routing Policy: ZeroTrust applied to NotificationStream.
 */

class ZeroTrustNotificationStreamPolicy {
...
module.exports = { ZeroTrustNotificationStreamPolicy };
