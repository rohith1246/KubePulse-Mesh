/**
 * ZeroTrustOrderEnginePolicy.js
 * Service Mesh Security & Routing Policy: ZeroTrust applied to OrderEngine.
 */

class ZeroTrustOrderEnginePolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 1300;
...
module.exports = { ZeroTrustOrderEnginePolicy };
