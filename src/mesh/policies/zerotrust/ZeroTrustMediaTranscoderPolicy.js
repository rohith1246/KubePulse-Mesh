/**
 * ZeroTrustMediaTranscoderPolicy.js
 * Service Mesh Security & Routing Policy: ZeroTrust applied to MediaTranscoder.
 */

class ZeroTrustMediaTranscoderPolicy {
...
module.exports = { ZeroTrustMediaTranscoderPolicy };
