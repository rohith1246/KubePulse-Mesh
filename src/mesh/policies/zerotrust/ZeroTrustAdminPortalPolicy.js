/**
 * ZeroTrustAdminPortalPolicy.js
 * Service Mesh Security & Routing Policy: ZeroTrust applied to AdminPortal.
 */

class ZeroTrustAdminPortalPolicy {
...
module.exports = { ZeroTrustAdminPortalPolicy };
