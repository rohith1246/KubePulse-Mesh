/**
 * ZeroTrustBillingGatewayPolicy.js
 * Service Mesh Security & Routing Policy: ZeroTrust applied to BillingGateway.
 */

class ZeroTrustBillingGatewayPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 1150;
...
module.exports = { ZeroTrustBillingGatewayPolicy };
