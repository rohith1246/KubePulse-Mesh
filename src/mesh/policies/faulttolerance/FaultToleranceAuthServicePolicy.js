/**
 * FaultToleranceAuthServicePolicy.js
 * Service Mesh Security & Routing Policy: FaultTolerance applied to AuthService.
 */

class FaultToleranceAuthServicePolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 1800;
...
module.exports = { FaultToleranceAuthServicePolicy };
