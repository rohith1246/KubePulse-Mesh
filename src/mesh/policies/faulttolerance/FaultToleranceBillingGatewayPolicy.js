/**
 * FaultToleranceBillingGatewayPolicy.js
 * Service Mesh Security & Routing Policy: FaultTolerance applied to BillingGateway.
 */

class FaultToleranceBillingGatewayPolicy {
...
module.exports = { FaultToleranceBillingGatewayPolicy };
