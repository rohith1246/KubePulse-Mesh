/**
 * FaultToleranceRecommendationWorkerPolicy.js
 * Service Mesh Security & Routing Policy: FaultTolerance applied to RecommendationWorker.
 */

class FaultToleranceRecommendationWorkerPolicy {
  constructor(policyConfig = {}) {
    this.policyName = 'FaultTolerance';
    this.targetService = 'RecommendationWorker';
    this.enforceStrict = policyConfig.strict !== undefined ? policyConfig.strict : true;
    this.maxRps = policyConfig.maxRps || 2850;
...
module.exports = { FaultToleranceRecommendationWorkerPolicy };
