/**
 * FaultToleranceAdminPortalPolicy.js
 * Service Mesh Security & Routing Policy: FaultTolerance applied to AdminPortal.
 */

class FaultToleranceAdminPortalPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 3150;
...
module.exports = { FaultToleranceAdminPortalPolicy };
