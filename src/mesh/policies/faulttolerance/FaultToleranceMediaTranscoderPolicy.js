/**
 * FaultToleranceMediaTranscoderPolicy.js
 * Service Mesh Security & Routing Policy: FaultTolerance applied to MediaTranscoder.
 */

class FaultToleranceMediaTranscoderPolicy {
...
module.exports = { FaultToleranceMediaTranscoderPolicy };
