/**
 * FaultToleranceAnalyticsPipelinePolicy.js
 * Service Mesh Security & Routing Policy: FaultTolerance applied to AnalyticsPipeline.
 */

class FaultToleranceAnalyticsPipelinePolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 2550;
...
module.exports = { FaultToleranceAnalyticsPipelinePolicy };
