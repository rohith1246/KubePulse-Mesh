/**
 * FaultToleranceOrderEnginePolicy.js
 * Service Mesh Security & Routing Policy: FaultTolerance applied to OrderEngine.
 */

class FaultToleranceOrderEnginePolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 2100;
...
module.exports = { FaultToleranceOrderEnginePolicy };
