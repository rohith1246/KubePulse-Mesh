/**
 * FaultToleranceNotificationStreamPolicy.js
 * Service Mesh Security & Routing Policy: FaultTolerance applied to NotificationStream.
 */

class FaultToleranceNotificationStreamPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 2400;
...
module.exports = { FaultToleranceNotificationStreamPolicy };
