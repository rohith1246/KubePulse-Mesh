/**
 * FaultToleranceSearchClusterPolicy.js
 * Service Mesh Security & Routing Policy: FaultTolerance applied to SearchCluster.
 */

class FaultToleranceSearchClusterPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 2700;
...
module.exports = { FaultToleranceSearchClusterPolicy };
