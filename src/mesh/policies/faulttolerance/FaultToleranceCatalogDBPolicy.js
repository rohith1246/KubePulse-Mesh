/**
 * FaultToleranceCatalogDBPolicy.js
 * Service Mesh Security & Routing Policy: FaultTolerance applied to CatalogDB.
 */

class FaultToleranceCatalogDBPolicy {
...
module.exports = { FaultToleranceCatalogDBPolicy };
