/**
 * GeoReplicationCatalogDBPolicy.js
 * Service Mesh Security & Routing Policy: GeoReplication applied to CatalogDB.
 */

class GeoReplicationCatalogDBPolicy {
...
module.exports = { GeoReplicationCatalogDBPolicy };
