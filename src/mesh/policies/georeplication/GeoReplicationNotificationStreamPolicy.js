/**
 * GeoReplicationNotificationStreamPolicy.js
 * Service Mesh Security & Routing Policy: GeoReplication applied to NotificationStream.
 */

class GeoReplicationNotificationStreamPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 3000;
...
module.exports = { GeoReplicationNotificationStreamPolicy };
