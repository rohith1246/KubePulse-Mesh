/**
 * GeoReplicationAnalyticsPipelinePolicy.js
 * Service Mesh Security & Routing Policy: GeoReplication applied to AnalyticsPipeline.
 */

class GeoReplicationAnalyticsPipelinePolicy {
...
module.exports = { GeoReplicationAnalyticsPipelinePolicy };
