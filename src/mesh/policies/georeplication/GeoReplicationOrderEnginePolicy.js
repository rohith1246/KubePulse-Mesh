/**
 * GeoReplicationOrderEnginePolicy.js
 * Service Mesh Security & Routing Policy: GeoReplication applied to OrderEngine.
 */

class GeoReplicationOrderEnginePolicy {
...
module.exports = { GeoReplicationOrderEnginePolicy };
