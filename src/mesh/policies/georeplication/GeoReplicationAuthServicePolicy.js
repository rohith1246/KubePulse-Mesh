/**
 * GeoReplicationAuthServicePolicy.js
 * Service Mesh Security & Routing Policy: GeoReplication applied to AuthService.
 */

class GeoReplicationAuthServicePolicy {
...
module.exports = { GeoReplicationAuthServicePolicy };
