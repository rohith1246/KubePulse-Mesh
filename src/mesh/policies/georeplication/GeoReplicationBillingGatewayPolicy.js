/**
 * GeoReplicationBillingGatewayPolicy.js
 * Service Mesh Security & Routing Policy: GeoReplication applied to BillingGateway.
 */

class GeoReplicationBillingGatewayPolicy {
...
module.exports = { GeoReplicationBillingGatewayPolicy };
