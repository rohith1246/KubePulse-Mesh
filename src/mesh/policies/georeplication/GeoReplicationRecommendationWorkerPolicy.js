/**
 * GeoReplicationRecommendationWorkerPolicy.js
 * Service Mesh Security & Routing Policy: GeoReplication applied to RecommendationWorker.
 */

class GeoReplicationRecommendationWorkerPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 3450;
...
module.exports = { GeoReplicationRecommendationWorkerPolicy };
