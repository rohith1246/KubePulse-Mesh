/**
 * GeoReplicationAdminPortalPolicy.js
 * Service Mesh Security & Routing Policy: GeoReplication applied to AdminPortal.
 */

class GeoReplicationAdminPortalPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 3750;
...
module.exports = { GeoReplicationAdminPortalPolicy };
