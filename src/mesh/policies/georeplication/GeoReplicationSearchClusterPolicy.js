/**
 * GeoReplicationSearchClusterPolicy.js
 * Service Mesh Security & Routing Policy: GeoReplication applied to SearchCluster.
 */

class GeoReplicationSearchClusterPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 3300;
...
module.exports = { GeoReplicationSearchClusterPolicy };
