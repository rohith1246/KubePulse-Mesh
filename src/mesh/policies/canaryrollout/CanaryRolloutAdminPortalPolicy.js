/**
 * CanaryRolloutAdminPortalPolicy.js
 * Service Mesh Security & Routing Policy: CanaryRollout applied to AdminPortal.
 */

class CanaryRolloutAdminPortalPolicy {
...
module.exports = { CanaryRolloutAdminPortalPolicy };
