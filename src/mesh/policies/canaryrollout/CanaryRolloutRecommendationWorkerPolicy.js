/**
 * CanaryRolloutRecommendationWorkerPolicy.js
 * Service Mesh Security & Routing Policy: CanaryRollout applied to RecommendationWorker.
 */

class CanaryRolloutRecommendationWorkerPolicy {
  constructor(policyConfig = {}) {
    this.policyName = 'CanaryRollout';
    this.targetService = 'RecommendationWorker';
    this.enforceStrict = policyConfig.strict !== undefined ? policyConfig.strict : true;
    this.maxRps = policyConfig.maxRps || 3250;
...
module.exports = { CanaryRolloutRecommendationWorkerPolicy };
