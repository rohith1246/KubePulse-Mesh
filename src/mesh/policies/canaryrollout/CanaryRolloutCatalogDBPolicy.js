/**
 * CanaryRolloutCatalogDBPolicy.js
 * Service Mesh Security & Routing Policy: CanaryRollout applied to CatalogDB.
 */

class CanaryRolloutCatalogDBPolicy {
...
module.exports = { CanaryRolloutCatalogDBPolicy };
