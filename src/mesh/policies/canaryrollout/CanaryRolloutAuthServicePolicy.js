/**
 * CanaryRolloutAuthServicePolicy.js
 * Service Mesh Security & Routing Policy: CanaryRollout applied to AuthService.
 */

class CanaryRolloutAuthServicePolicy {
...
module.exports = { CanaryRolloutAuthServicePolicy };
