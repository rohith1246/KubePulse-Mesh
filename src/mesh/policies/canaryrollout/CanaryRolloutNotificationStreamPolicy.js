/**
 * CanaryRolloutNotificationStreamPolicy.js
 * Service Mesh Security & Routing Policy: CanaryRollout applied to NotificationStream.
 */

class CanaryRolloutNotificationStreamPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 2800;
...
module.exports = { CanaryRolloutNotificationStreamPolicy };
