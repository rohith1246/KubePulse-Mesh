/**
 * CanaryRolloutBillingGatewayPolicy.js
 * Service Mesh Security & Routing Policy: CanaryRollout applied to BillingGateway.
 */

class CanaryRolloutBillingGatewayPolicy {
...
module.exports = { CanaryRolloutBillingGatewayPolicy };
