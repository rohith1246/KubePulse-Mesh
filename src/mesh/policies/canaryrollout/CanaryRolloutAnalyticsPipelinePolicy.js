/**
 * CanaryRolloutAnalyticsPipelinePolicy.js
 * Service Mesh Security & Routing Policy: CanaryRollout applied to AnalyticsPipeline.
 */

class CanaryRolloutAnalyticsPipelinePolicy {
...
module.exports = { CanaryRolloutAnalyticsPipelinePolicy };
