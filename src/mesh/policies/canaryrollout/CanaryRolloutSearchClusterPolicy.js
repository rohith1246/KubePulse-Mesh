/**
 * CanaryRolloutSearchClusterPolicy.js
 * Service Mesh Security & Routing Policy: CanaryRollout applied to SearchCluster.
 */

class CanaryRolloutSearchClusterPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 3100;
...
module.exports = { CanaryRolloutSearchClusterPolicy };
