/**
 * CanaryRolloutMediaTranscoderPolicy.js
 * Service Mesh Security & Routing Policy: CanaryRollout applied to MediaTranscoder.
 */

class CanaryRolloutMediaTranscoderPolicy {
...
module.exports = { CanaryRolloutMediaTranscoderPolicy };
