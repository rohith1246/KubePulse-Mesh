/**
 * CanaryRolloutOrderEnginePolicy.js
 * Service Mesh Security & Routing Policy: CanaryRollout applied to OrderEngine.
 */

class CanaryRolloutOrderEnginePolicy {
...
module.exports = { CanaryRolloutOrderEnginePolicy };
