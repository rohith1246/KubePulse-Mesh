/**
 * EgressFirewallAnalyticsPipelinePolicy.js
 * Service Mesh Security & Routing Policy: EgressFirewall applied to AnalyticsPipeline.
 */

class EgressFirewallAnalyticsPipelinePolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 3550;
...
module.exports = { EgressFirewallAnalyticsPipelinePolicy };
