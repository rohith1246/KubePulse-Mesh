/**
 * EgressFirewallSearchClusterPolicy.js
 * Service Mesh Security & Routing Policy: EgressFirewall applied to SearchCluster.
 */

class EgressFirewallSearchClusterPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 3700;
...
module.exports = { EgressFirewallSearchClusterPolicy };
