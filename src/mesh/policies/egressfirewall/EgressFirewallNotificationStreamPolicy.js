/**
 * EgressFirewallNotificationStreamPolicy.js
 * Service Mesh Security & Routing Policy: EgressFirewall applied to NotificationStream.
 */

class EgressFirewallNotificationStreamPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 3400;
...
module.exports = { EgressFirewallNotificationStreamPolicy };
