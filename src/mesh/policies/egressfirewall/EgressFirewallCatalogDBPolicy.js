/**
 * EgressFirewallCatalogDBPolicy.js
 * Service Mesh Security & Routing Policy: EgressFirewall applied to CatalogDB.
 */

class EgressFirewallCatalogDBPolicy {
...
module.exports = { EgressFirewallCatalogDBPolicy };
