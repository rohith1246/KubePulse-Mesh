/**
 * EgressFirewallMediaTranscoderPolicy.js
 * Service Mesh Security & Routing Policy: EgressFirewall applied to MediaTranscoder.
 */

class EgressFirewallMediaTranscoderPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 4000;
...
module.exports = { EgressFirewallMediaTranscoderPolicy };
