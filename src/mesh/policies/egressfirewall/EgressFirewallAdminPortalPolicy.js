/**
 * EgressFirewallAdminPortalPolicy.js
 * Service Mesh Security & Routing Policy: EgressFirewall applied to AdminPortal.
 */

class EgressFirewallAdminPortalPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 4150;
...
module.exports = { EgressFirewallAdminPortalPolicy };
