/**
 * EgressFirewallOrderEnginePolicy.js
 * Service Mesh Security & Routing Policy: EgressFirewall applied to OrderEngine.
 */

class EgressFirewallOrderEnginePolicy {
...
module.exports = { EgressFirewallOrderEnginePolicy };
