/**
 * EgressFirewallBillingGatewayPolicy.js
 * Service Mesh Security & Routing Policy: EgressFirewall applied to BillingGateway.
 */

class EgressFirewallBillingGatewayPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 2950;
...
module.exports = { EgressFirewallBillingGatewayPolicy };
