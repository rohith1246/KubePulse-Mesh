/**
 * EgressFirewallAuthServicePolicy.js
 * Service Mesh Security & Routing Policy: EgressFirewall applied to AuthService.
 */

class EgressFirewallAuthServicePolicy {
...
module.exports = { EgressFirewallAuthServicePolicy };
