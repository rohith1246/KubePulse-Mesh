/**
 * MutualTLSAuthServicePolicy.js
 * Service Mesh Security & Routing Policy: MutualTLS applied to AuthService.
 */

class MutualTLSAuthServicePolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 1200;
...
module.exports = { MutualTLSAuthServicePolicy };
