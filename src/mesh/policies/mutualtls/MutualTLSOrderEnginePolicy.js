/**
 * MutualTLSOrderEnginePolicy.js
 * Service Mesh Security & Routing Policy: MutualTLS applied to OrderEngine.
 */

class MutualTLSOrderEnginePolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 1500;
...
module.exports = { MutualTLSOrderEnginePolicy };
