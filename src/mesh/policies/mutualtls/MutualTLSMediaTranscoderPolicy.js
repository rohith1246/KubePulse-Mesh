/**
 * MutualTLSMediaTranscoderPolicy.js
 * Service Mesh Security & Routing Policy: MutualTLS applied to MediaTranscoder.
 */

class MutualTLSMediaTranscoderPolicy {
...
module.exports = { MutualTLSMediaTranscoderPolicy };
