/**
 * MutualTLSSearchClusterPolicy.js
 * Service Mesh Security & Routing Policy: MutualTLS applied to SearchCluster.
 */

class MutualTLSSearchClusterPolicy {
...
module.exports = { MutualTLSSearchClusterPolicy };
