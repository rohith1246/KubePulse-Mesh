/**
 * MutualTLSAdminPortalPolicy.js
 * Service Mesh Security & Routing Policy: MutualTLS applied to AdminPortal.
 */

class MutualTLSAdminPortalPolicy {
...
module.exports = { MutualTLSAdminPortalPolicy };
