/**
 * MutualTLSCatalogDBPolicy.js
 * Service Mesh Security & Routing Policy: MutualTLS applied to CatalogDB.
 */

class MutualTLSCatalogDBPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 1650;
...
module.exports = { MutualTLSCatalogDBPolicy };
