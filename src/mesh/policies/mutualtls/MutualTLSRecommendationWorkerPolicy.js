/**
 * MutualTLSRecommendationWorkerPolicy.js
 * Service Mesh Security & Routing Policy: MutualTLS applied to RecommendationWorker.
 */

class MutualTLSRecommendationWorkerPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 2250;
...
module.exports = { MutualTLSRecommendationWorkerPolicy };
