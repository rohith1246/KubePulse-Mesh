/**
 * MutualTLSBillingGatewayPolicy.js
 * Service Mesh Security & Routing Policy: MutualTLS applied to BillingGateway.
 */

class MutualTLSBillingGatewayPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 1350;
...
module.exports = { MutualTLSBillingGatewayPolicy };
