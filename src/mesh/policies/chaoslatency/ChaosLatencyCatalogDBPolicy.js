/**
 * ChaosLatencyCatalogDBPolicy.js
 * Service Mesh Security & Routing Policy: ChaosLatency applied to CatalogDB.
 */

class ChaosLatencyCatalogDBPolicy {
...
module.exports = { ChaosLatencyCatalogDBPolicy };
