/**
 * ChaosLatencyAdminPortalPolicy.js
 * Service Mesh Security & Routing Policy: ChaosLatency applied to AdminPortal.
 */

class ChaosLatencyAdminPortalPolicy {
...
module.exports = { ChaosLatencyAdminPortalPolicy };
