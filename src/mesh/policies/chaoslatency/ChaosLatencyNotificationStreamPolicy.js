/**
 * ChaosLatencyNotificationStreamPolicy.js
 * Service Mesh Security & Routing Policy: ChaosLatency applied to NotificationStream.
 */

class ChaosLatencyNotificationStreamPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 2600;
...
module.exports = { ChaosLatencyNotificationStreamPolicy };
