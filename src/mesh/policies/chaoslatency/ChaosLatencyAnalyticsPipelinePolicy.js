/**
 * ChaosLatencyAnalyticsPipelinePolicy.js
 * Service Mesh Security & Routing Policy: ChaosLatency applied to AnalyticsPipeline.
 */

class ChaosLatencyAnalyticsPipelinePolicy {
...
module.exports = { ChaosLatencyAnalyticsPipelinePolicy };
