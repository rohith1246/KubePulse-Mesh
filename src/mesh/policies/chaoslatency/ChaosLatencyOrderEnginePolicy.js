/**
 * ChaosLatencyOrderEnginePolicy.js
 * Service Mesh Security & Routing Policy: ChaosLatency applied to OrderEngine.
 */

class ChaosLatencyOrderEnginePolicy {
...
module.exports = { ChaosLatencyOrderEnginePolicy };
