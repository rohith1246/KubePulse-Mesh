/**
 * ChaosLatencyBillingGatewayPolicy.js
 * Service Mesh Security & Routing Policy: ChaosLatency applied to BillingGateway.
 */

class ChaosLatencyBillingGatewayPolicy {
...
module.exports = { ChaosLatencyBillingGatewayPolicy };
