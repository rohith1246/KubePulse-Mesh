/**
 * ChaosLatencyRecommendationWorkerPolicy.js
 * Service Mesh Security & Routing Policy: ChaosLatency applied to RecommendationWorker.
 */

class ChaosLatencyRecommendationWorkerPolicy {
  constructor(policyConfig = {}) {
    this.policyName = 'ChaosLatency';
    this.targetService = 'RecommendationWorker';
    this.enforceStrict = policyConfig.strict !== undefined ? policyConfig.strict : true;
    this.maxRps = policyConfig.maxRps || 3050;
...
module.exports = { ChaosLatencyRecommendationWorkerPolicy };
