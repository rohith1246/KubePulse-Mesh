/**
 * ChaosLatencyAuthServicePolicy.js
 * Service Mesh Security & Routing Policy: ChaosLatency applied to AuthService.
 */

class ChaosLatencyAuthServicePolicy {
...
module.exports = { ChaosLatencyAuthServicePolicy };
