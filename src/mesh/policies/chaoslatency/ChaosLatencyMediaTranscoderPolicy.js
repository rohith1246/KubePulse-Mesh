/**
 * ChaosLatencyMediaTranscoderPolicy.js
 * Service Mesh Security & Routing Policy: ChaosLatency applied to MediaTranscoder.
 */

class ChaosLatencyMediaTranscoderPolicy {
...
module.exports = { ChaosLatencyMediaTranscoderPolicy };
