/**
 * ChaosLatencySearchClusterPolicy.js
 * Service Mesh Security & Routing Policy: ChaosLatency applied to SearchCluster.
 */

class ChaosLatencySearchClusterPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 2900;
...
module.exports = { ChaosLatencySearchClusterPolicy };
