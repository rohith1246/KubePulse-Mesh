/**
 * CircuitBreakerTripRecommendationWorkerPolicy.js
 * Service Mesh Security & Routing Policy: CircuitBreakerTrip applied to RecommendationWorker.
 */

class CircuitBreakerTripRecommendationWorkerPolicy {
  constructor(policyConfig = {}) {
    this.policyName = 'CircuitBreakerTrip';
    this.targetService = 'RecommendationWorker';
    this.enforceStrict = policyConfig.strict !== undefined ? policyConfig.strict : true;
    this.maxRps = policyConfig.maxRps || 2650;
...
module.exports = { CircuitBreakerTripRecommendationWorkerPolicy };
