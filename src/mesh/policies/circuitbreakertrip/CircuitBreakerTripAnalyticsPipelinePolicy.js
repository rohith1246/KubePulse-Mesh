/**
 * CircuitBreakerTripAnalyticsPipelinePolicy.js
 * Service Mesh Security & Routing Policy: CircuitBreakerTrip applied to AnalyticsPipeline.
 */

class CircuitBreakerTripAnalyticsPipelinePolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 2350;
...
module.exports = { CircuitBreakerTripAnalyticsPipelinePolicy };
