/**
 * CircuitBreakerTripNotificationStreamPolicy.js
 * Service Mesh Security & Routing Policy: CircuitBreakerTrip applied to NotificationStream.
 */

class CircuitBreakerTripNotificationStreamPolicy {
  constructor(policyConfig = {}) {
    this.policyName = 'CircuitBreakerTrip';
    this.targetService = 'NotificationStream';
    this.enforceStrict = policyConfig.strict !== undefined ? policyConfig.strict : true;
    this.maxRps = policyConfig.maxRps || 2200;
...
module.exports = { CircuitBreakerTripNotificationStreamPolicy };
