/**
 * CircuitBreakerTripSearchClusterPolicy.js
 * Service Mesh Security & Routing Policy: CircuitBreakerTrip applied to SearchCluster.
 */

class CircuitBreakerTripSearchClusterPolicy {
  constructor(policyConfig = {}) {
    this.policyName = 'CircuitBreakerTrip';
    this.targetService = 'SearchCluster';
    this.enforceStrict = policyConfig.strict !== undefined ? policyConfig.strict : true;
    this.maxRps = policyConfig.maxRps || 2500;
...
module.exports = { CircuitBreakerTripSearchClusterPolicy };
