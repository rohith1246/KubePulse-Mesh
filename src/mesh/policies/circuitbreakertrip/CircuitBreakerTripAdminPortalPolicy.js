/**
 * CircuitBreakerTripAdminPortalPolicy.js
 * Service Mesh Security & Routing Policy: CircuitBreakerTrip applied to AdminPortal.
 */

class CircuitBreakerTripAdminPortalPolicy {
...
module.exports = { CircuitBreakerTripAdminPortalPolicy };
