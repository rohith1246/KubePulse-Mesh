/**
 * CircuitBreakerTripBillingGatewayPolicy.js
 * Service Mesh Security & Routing Policy: CircuitBreakerTrip applied to BillingGateway.
 */

class CircuitBreakerTripBillingGatewayPolicy {
  constructor(policyConfig = {}) {
    this.policyName = 'CircuitBreakerTrip';
    this.targetService = 'BillingGateway';
    this.enforceStrict = policyConfig.strict !== undefined ? policyConfig.strict : true;
    this.maxRps = policyConfig.maxRps || 1750;
...
module.exports = { CircuitBreakerTripBillingGatewayPolicy };
