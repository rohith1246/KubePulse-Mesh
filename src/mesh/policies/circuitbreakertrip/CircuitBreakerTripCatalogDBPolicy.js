/**
 * CircuitBreakerTripCatalogDBPolicy.js
 * Service Mesh Security & Routing Policy: CircuitBreakerTrip applied to CatalogDB.
 */

class CircuitBreakerTripCatalogDBPolicy {
  constructor(policyConfig = {}) {
    this.policyName = 'CircuitBreakerTrip';
    this.targetService = 'CatalogDB';
...
module.exports = { CircuitBreakerTripCatalogDBPolicy };
