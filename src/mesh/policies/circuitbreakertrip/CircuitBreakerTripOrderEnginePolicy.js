/**
 * CircuitBreakerTripOrderEnginePolicy.js
 * Service Mesh Security & Routing Policy: CircuitBreakerTrip applied to OrderEngine.
 */

class CircuitBreakerTripOrderEnginePolicy {
  constructor(policyConfig = {}) {
    this.policyName = 'CircuitBreakerTrip';
    this.targetService = 'OrderEngine';
    this.enforceStrict = policyConfig.strict !== undefined ? policyConfig.strict : true;
    this.maxRps = policyConfig.maxRps || 1900;
...
module.exports = { CircuitBreakerTripOrderEnginePolicy };
