/**
 * CircuitBreakerTripAuthServicePolicy.js
 * Service Mesh Security & Routing Policy: CircuitBreakerTrip applied to AuthService.
 */

class CircuitBreakerTripAuthServicePolicy {
  constructor(policyConfig = {}) {
    this.policyName = 'CircuitBreakerTrip';
    this.targetService = 'AuthService';
    this.enforceStrict = policyConfig.strict !== undefined ? policyConfig.strict : true;
    this.maxRps = policyConfig.maxRps || 1600;
...
module.exports = { CircuitBreakerTripAuthServicePolicy };
