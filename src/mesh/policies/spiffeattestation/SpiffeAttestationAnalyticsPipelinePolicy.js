/**
 * SpiffeAttestationAnalyticsPipelinePolicy.js
 * Service Mesh Security & Routing Policy: SpiffeAttestation applied to AnalyticsPipeline.
 */

class SpiffeAttestationAnalyticsPipelinePolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 3350;
...
module.exports = { SpiffeAttestationAnalyticsPipelinePolicy };
