/**
 * SpiffeAttestationSearchClusterPolicy.js
 * Service Mesh Security & Routing Policy: SpiffeAttestation applied to SearchCluster.
 */

class SpiffeAttestationSearchClusterPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 3500;
...
module.exports = { SpiffeAttestationSearchClusterPolicy };
