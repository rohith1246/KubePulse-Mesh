/**
 * SpiffeAttestationNotificationStreamPolicy.js
 * Service Mesh Security & Routing Policy: SpiffeAttestation applied to NotificationStream.
 */

class SpiffeAttestationNotificationStreamPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 3200;
...
module.exports = { SpiffeAttestationNotificationStreamPolicy };
