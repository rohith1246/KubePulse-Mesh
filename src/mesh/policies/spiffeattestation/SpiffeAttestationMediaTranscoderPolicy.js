/**
 * SpiffeAttestationMediaTranscoderPolicy.js
 * Service Mesh Security & Routing Policy: SpiffeAttestation applied to MediaTranscoder.
 */

class SpiffeAttestationMediaTranscoderPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 3800;
...
module.exports = { SpiffeAttestationMediaTranscoderPolicy };
