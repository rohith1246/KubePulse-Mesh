/**
 * SpiffeAttestationAuthServicePolicy.js
 * Service Mesh Security & Routing Policy: SpiffeAttestation applied to AuthService.
 */

class SpiffeAttestationAuthServicePolicy {
...
module.exports = { SpiffeAttestationAuthServicePolicy };
