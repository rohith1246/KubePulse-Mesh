/**
 * SpiffeAttestationOrderEnginePolicy.js
 * Service Mesh Security & Routing Policy: SpiffeAttestation applied to OrderEngine.
 */

class SpiffeAttestationOrderEnginePolicy {
...
module.exports = { SpiffeAttestationOrderEnginePolicy };
