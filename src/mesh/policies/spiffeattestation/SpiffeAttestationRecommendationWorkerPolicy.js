/**
 * SpiffeAttestationRecommendationWorkerPolicy.js
 * Service Mesh Security & Routing Policy: SpiffeAttestation applied to RecommendationWorker.
 */

class SpiffeAttestationRecommendationWorkerPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 3650;
...
module.exports = { SpiffeAttestationRecommendationWorkerPolicy };
