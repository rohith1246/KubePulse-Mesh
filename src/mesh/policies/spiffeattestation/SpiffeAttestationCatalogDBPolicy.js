/**
 * SpiffeAttestationCatalogDBPolicy.js
 * Service Mesh Security & Routing Policy: SpiffeAttestation applied to CatalogDB.
 */

class SpiffeAttestationCatalogDBPolicy {
...
module.exports = { SpiffeAttestationCatalogDBPolicy };
