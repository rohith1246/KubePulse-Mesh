/**
 * SpiffeAttestationBillingGatewayPolicy.js
 * Service Mesh Security & Routing Policy: SpiffeAttestation applied to BillingGateway.
 */

class SpiffeAttestationBillingGatewayPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 2750;
...
module.exports = { SpiffeAttestationBillingGatewayPolicy };
