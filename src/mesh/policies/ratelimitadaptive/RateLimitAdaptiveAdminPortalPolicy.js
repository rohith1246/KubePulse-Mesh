/**
 * RateLimitAdaptiveAdminPortalPolicy.js
 * Service Mesh Security & Routing Policy: RateLimitAdaptive applied to AdminPortal.
 */

class RateLimitAdaptiveAdminPortalPolicy {
...
module.exports = { RateLimitAdaptiveAdminPortalPolicy };
