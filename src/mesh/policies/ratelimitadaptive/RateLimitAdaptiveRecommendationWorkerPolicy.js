/**
 * RateLimitAdaptiveRecommendationWorkerPolicy.js
 * Service Mesh Security & Routing Policy: RateLimitAdaptive applied to RecommendationWorker.
 */

class RateLimitAdaptiveRecommendationWorkerPolicy {
  constructor(policyConfig = {}) {
    this.policyName = 'RateLimitAdaptive';
    this.targetService = 'RecommendationWorker';
    this.enforceStrict = policyConfig.strict !== undefined ? policyConfig.strict : true;
    this.maxRps = policyConfig.maxRps || 2450;
...
module.exports = { RateLimitAdaptiveRecommendationWorkerPolicy };
