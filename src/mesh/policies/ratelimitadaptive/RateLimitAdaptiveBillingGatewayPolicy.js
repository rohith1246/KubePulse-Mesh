/**
 * RateLimitAdaptiveBillingGatewayPolicy.js
 * Service Mesh Security & Routing Policy: RateLimitAdaptive applied to BillingGateway.
 */

class RateLimitAdaptiveBillingGatewayPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 1550;
...
module.exports = { RateLimitAdaptiveBillingGatewayPolicy };
