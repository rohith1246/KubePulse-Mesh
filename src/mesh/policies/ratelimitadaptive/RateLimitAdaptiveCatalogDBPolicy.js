/**
 * RateLimitAdaptiveCatalogDBPolicy.js
 * Service Mesh Security & Routing Policy: RateLimitAdaptive applied to CatalogDB.
 */

class RateLimitAdaptiveCatalogDBPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 1850;
...
module.exports = { RateLimitAdaptiveCatalogDBPolicy };
