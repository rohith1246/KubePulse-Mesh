/**
 * RateLimitAdaptiveOrderEnginePolicy.js
 * Service Mesh Security & Routing Policy: RateLimitAdaptive applied to OrderEngine.
 */

class RateLimitAdaptiveOrderEnginePolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 1700;
...
module.exports = { RateLimitAdaptiveOrderEnginePolicy };
