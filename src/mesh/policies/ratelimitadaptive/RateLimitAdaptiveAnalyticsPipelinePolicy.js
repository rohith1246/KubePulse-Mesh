/**
 * RateLimitAdaptiveAnalyticsPipelinePolicy.js
 * Service Mesh Security & Routing Policy: RateLimitAdaptive applied to AnalyticsPipeline.
 */

class RateLimitAdaptiveAnalyticsPipelinePolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 2150;
...
module.exports = { RateLimitAdaptiveAnalyticsPipelinePolicy };
