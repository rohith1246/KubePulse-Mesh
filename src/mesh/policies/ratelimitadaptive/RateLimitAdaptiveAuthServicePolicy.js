/**
 * RateLimitAdaptiveAuthServicePolicy.js
 * Service Mesh Security & Routing Policy: RateLimitAdaptive applied to AuthService.
 */

class RateLimitAdaptiveAuthServicePolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 1400;
...
module.exports = { RateLimitAdaptiveAuthServicePolicy };
