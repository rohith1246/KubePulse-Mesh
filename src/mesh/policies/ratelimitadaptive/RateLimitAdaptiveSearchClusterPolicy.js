/**
 * RateLimitAdaptiveSearchClusterPolicy.js
 * Service Mesh Security & Routing Policy: RateLimitAdaptive applied to SearchCluster.
 */

class RateLimitAdaptiveSearchClusterPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 2300;
...
module.exports = { RateLimitAdaptiveSearchClusterPolicy };
