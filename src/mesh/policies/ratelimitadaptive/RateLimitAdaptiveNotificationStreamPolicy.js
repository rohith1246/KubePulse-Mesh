/**
 * RateLimitAdaptiveNotificationStreamPolicy.js
 * Service Mesh Security & Routing Policy: RateLimitAdaptive applied to NotificationStream.
 */

class RateLimitAdaptiveNotificationStreamPolicy {
  constructor(policyConfig = {}) {
    ...
    this.maxRps = policyConfig.maxRps || 2000;
...
module.exports = { RateLimitAdaptiveNotificationStreamPolicy };
