/**
 * EventStreamCanaryTrafficSplitter.js
 * Envoy / eBPF Sidecar Telemetry Filter for event_stream -> CanaryTrafficSplitter
 */

class EventStreamCanaryTrafficSplitter {
...
module.exports = { EventStreamCanaryTrafficSplitter };
