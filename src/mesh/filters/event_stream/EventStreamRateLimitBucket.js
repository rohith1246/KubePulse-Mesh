/**
 * EventStreamRateLimitBucket.js
 * Envoy / eBPF Sidecar Telemetry Filter for event_stream -> RateLimitBucket
 */

class EventStreamRateLimitBucket {
...
module.exports = { EventStreamRateLimitBucket };
