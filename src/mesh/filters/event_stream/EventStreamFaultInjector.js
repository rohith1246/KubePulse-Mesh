/**
 * EventStreamFaultInjector.js
 * Envoy / eBPF Sidecar Telemetry Filter for event_stream -> FaultInjector
 */

class EventStreamFaultInjector {
...
module.exports = { EventStreamFaultInjector };
