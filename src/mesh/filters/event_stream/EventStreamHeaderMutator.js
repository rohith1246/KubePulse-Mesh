/**
 * EventStreamHeaderMutator.js
 * Envoy / eBPF Sidecar Telemetry Filter for event_stream -> HeaderMutator
 */

class EventStreamHeaderMutator {
...
module.exports = { EventStreamHeaderMutator };
