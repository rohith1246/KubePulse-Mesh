/**
 * EventStreamTlsHandshakeMonitor.js
 * Envoy / eBPF Sidecar Telemetry Filter for event_stream -> TlsHandshakeMonitor
 */

class EventStreamTlsHandshakeMonitor {
...
module.exports = { EventStreamTlsHandshakeMonitor };
