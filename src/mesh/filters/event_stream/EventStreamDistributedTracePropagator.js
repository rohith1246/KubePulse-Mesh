/**
 * EventStreamDistributedTracePropagator.js
 * Envoy / eBPF Sidecar Telemetry Filter for event_stream -> DistributedTracePropagator
 */

class EventStreamDistributedTracePropagator {
  constructor(filterConfig = {}) {
    this.layerName = 'event_stream';
...
module.exports = { EventStreamDistributedTracePropagator };
