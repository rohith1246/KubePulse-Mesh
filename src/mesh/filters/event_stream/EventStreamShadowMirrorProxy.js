/**
 * EventStreamShadowMirrorProxy.js
 * Envoy / eBPF Sidecar Telemetry Filter for event_stream -> ShadowMirrorProxy
 */

class EventStreamShadowMirrorProxy {
...
module.exports = { EventStreamShadowMirrorProxy };
