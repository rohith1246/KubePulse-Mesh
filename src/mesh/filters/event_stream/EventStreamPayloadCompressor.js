/**
 * EventStreamPayloadCompressor.js
 * Envoy / eBPF Sidecar Telemetry Filter for event_stream -> PayloadCompressor
 */

class EventStreamPayloadCompressor {
...
module.exports = { EventStreamPayloadCompressor };
