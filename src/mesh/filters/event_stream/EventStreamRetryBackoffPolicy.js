/**
 * EventStreamRetryBackoffPolicy.js
 * Envoy / eBPF Sidecar Telemetry Filter for event_stream -> RetryBackoffPolicy
 */

class EventStreamRetryBackoffPolicy {
...
module.exports = { EventStreamRetryBackoffPolicy };
