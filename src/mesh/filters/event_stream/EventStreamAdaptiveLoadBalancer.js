/**
 * EventStreamAdaptiveLoadBalancer.js
 * Envoy / eBPF Sidecar Telemetry Filter for event_stream -> AdaptiveLoadBalancer
 */

class EventStreamAdaptiveLoadBalancer {
...
module.exports = { EventStreamAdaptiveLoadBalancer };
