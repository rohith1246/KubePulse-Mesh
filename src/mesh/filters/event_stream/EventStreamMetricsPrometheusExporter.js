/**
 * EventStreamMetricsPrometheusExporter.js
 * Envoy / eBPF Sidecar Telemetry Filter for event_stream -> MetricsPrometheusExporter
 */

class EventStreamMetricsPrometheusExporter {
...
module.exports = { EventStreamMetricsPrometheusExporter };
