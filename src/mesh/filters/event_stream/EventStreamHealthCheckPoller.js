/**
 * EventStreamHealthCheckPoller.js
 * Envoy / eBPF Sidecar Telemetry Filter for event_stream -> HealthCheckPoller
 */

class EventStreamHealthCheckPoller {
...
module.exports = { EventStreamHealthCheckPoller };
