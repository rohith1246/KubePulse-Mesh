/**
 * EventStreamCircuitBreakerState.js
 * Envoy / eBPF Sidecar Telemetry Filter for event_stream -> CircuitBreakerState
 */

class EventStreamCircuitBreakerState {
...
module.exports = { EventStreamCircuitBreakerState };
