/**
 * EventStreamSpiffeIdentityVerifier.js
 * Envoy / eBPF Sidecar Telemetry Filter for event_stream -> SpiffeIdentityVerifier
 */

class EventStreamSpiffeIdentityVerifier {
...
module.exports = { EventStreamSpiffeIdentityVerifier };
