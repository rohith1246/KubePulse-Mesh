/**
 * EventStreamLatencyHistogram.js
 * Envoy / eBPF Sidecar Telemetry Filter for event_stream -> LatencyHistogram
 */

class EventStreamLatencyHistogram {
...
module.exports = { EventStreamLatencyHistogram };
