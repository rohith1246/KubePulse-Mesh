/**
 * NotificationQueueRetryBackoffPolicy.js
 * Envoy / eBPF Sidecar Telemetry Filter for notification_queue -> RetryBackoffPolicy
 */

class NotificationQueueRetryBackoffPolicy {
...
module.exports = { NotificationQueueRetryBackoffPolicy };
