/**
 * NotificationQueueCircuitBreakerState.js
 * Envoy / eBPF Sidecar Telemetry Filter for notification_queue -> CircuitBreakerState
 */

class NotificationQueueCircuitBreakerState {
...
module.exports = { NotificationQueueCircuitBreakerState };
