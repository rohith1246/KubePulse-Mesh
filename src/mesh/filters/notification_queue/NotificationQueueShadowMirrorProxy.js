/**
 * NotificationQueueShadowMirrorProxy.js
 * Envoy / eBPF Sidecar Telemetry Filter for notification_queue -> ShadowMirrorProxy
 */

class NotificationQueueShadowMirrorProxy {
  constructor(filterConfig = {}) {
    this.layerName = 'notification_queue';
    this.filterType = 'ShadowMirrorProxy';
...
module.exports = { NotificationQueueShadowMirrorProxy };
