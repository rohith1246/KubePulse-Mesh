/**
 * NotificationQueueLatencyHistogram.js
 * Envoy / eBPF Sidecar Telemetry Filter for notification_queue -> LatencyHistogram
 */

class NotificationQueueLatencyHistogram {
...
module.exports = { NotificationQueueLatencyHistogram };
