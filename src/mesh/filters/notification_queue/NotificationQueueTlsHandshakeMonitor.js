/**
 * NotificationQueueTlsHandshakeMonitor.js
 * Envoy / eBPF Sidecar Telemetry Filter for notification_queue -> TlsHandshakeMonitor
 */

class NotificationQueueTlsHandshakeMonitor {
...
module.exports = { NotificationQueueTlsHandshakeMonitor };
