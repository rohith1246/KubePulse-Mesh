/**
 * NotificationQueuePayloadCompressor.js
 * Envoy / eBPF Sidecar Telemetry Filter for notification_queue -> PayloadCompressor
 */

class NotificationQueuePayloadCompressor {
...
module.exports = { NotificationQueuePayloadCompressor };
