/**
 * NotificationQueueDistributedTracePropagator.js
 * Envoy / eBPF Sidecar Telemetry Filter for notification_queue -> DistributedTracePropagator
 */

class NotificationQueueDistributedTracePropagator {
  constructor(filterConfig = {}) {
    this.layerName = 'notification_queue';
...
module.exports = { NotificationQueueDistributedTracePropagator };
