/**
 * NotificationQueueHealthCheckPoller.js
 * Envoy / eBPF Sidecar Telemetry Filter for notification_queue -> HealthCheckPoller
 */

class NotificationQueueHealthCheckPoller {
...
module.exports = { NotificationQueueHealthCheckPoller };
