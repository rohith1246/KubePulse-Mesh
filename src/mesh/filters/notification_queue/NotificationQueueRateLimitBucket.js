/**
 * NotificationQueueRateLimitBucket.js
 * Envoy / eBPF Sidecar Telemetry Filter for notification_queue -> RateLimitBucket
 */

class NotificationQueueRateLimitBucket {
...
module.exports = { NotificationQueueRateLimitBucket };
