/**
 * NotificationQueueHeaderMutator.js
 * Envoy / eBPF Sidecar Telemetry Filter for notification_queue -> HeaderMutator
 */

class NotificationQueueHeaderMutator {
...
module.exports = { NotificationQueueHeaderMutator };
