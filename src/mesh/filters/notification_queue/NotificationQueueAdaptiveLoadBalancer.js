/**
 * NotificationQueueAdaptiveLoadBalancer.js
 * Envoy / eBPF Sidecar Telemetry Filter for notification_queue -> AdaptiveLoadBalancer
 */

class NotificationQueueAdaptiveLoadBalancer {
...
module.exports = { NotificationQueueAdaptiveLoadBalancer };
