/**
 * NotificationQueueFaultInjector.js
 * Envoy / eBPF Sidecar Telemetry Filter for notification_queue -> FaultInjector
 */

class NotificationQueueFaultInjector {
...
module.exports = { NotificationQueueFaultInjector };
