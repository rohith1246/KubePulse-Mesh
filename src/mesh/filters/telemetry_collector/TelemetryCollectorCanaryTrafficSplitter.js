/**
 * TelemetryCollectorCanaryTrafficSplitter.js
 * Envoy / eBPF Sidecar Telemetry Filter for telemetry_collector -> CanaryTrafficSplitter
 */

class TelemetryCollectorCanaryTrafficSplitter {
  constructor(filterConfig = {}) {
    this.layerName = 'telemetry_collector';
    this.filterType = 'CanaryTrafficSplitter';
...
module.exports = { TelemetryCollectorCanaryTrafficSplitter };
