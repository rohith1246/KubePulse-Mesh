/**
 * TelemetryCollectorShadowMirrorProxy.js
 * Envoy / eBPF Sidecar Telemetry Filter for telemetry_collector -> ShadowMirrorProxy
 */

class TelemetryCollectorShadowMirrorProxy {
...
module.exports = { TelemetryCollectorShadowMirrorProxy };
