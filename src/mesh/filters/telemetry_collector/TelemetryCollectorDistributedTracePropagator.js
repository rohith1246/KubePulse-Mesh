/**
 * TelemetryCollectorDistributedTracePropagator.js
 * Envoy / eBPF Sidecar Telemetry Filter for telemetry_collector -> DistributedTracePropagator
 */

class TelemetryCollectorDistributedTracePropagator {
  constructor(filterConfig = {}) {
    this.layerName = 'telemetry_collector';
    this.filterType = 'DistributedTracePropagator';
...
module.exports = { TelemetryCollectorDistributedTracePropagator };
