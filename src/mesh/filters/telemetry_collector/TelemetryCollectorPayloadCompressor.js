/**
 * TelemetryCollectorPayloadCompressor.js
 * Envoy / eBPF Sidecar Telemetry Filter for telemetry_collector -> PayloadCompressor
 */

class TelemetryCollectorPayloadCompressor {
  constructor(filterConfig = {}) {
    this.layerName = 'telemetry_collector';
    this.filterType = 'PayloadCompressor';
...
module.exports = { TelemetryCollectorPayloadCompressor };
