/**
 * TelemetryCollectorCircuitBreakerState.js
 * Envoy / eBPF Sidecar Telemetry Filter for telemetry_collector -> CircuitBreakerState
 */

class TelemetryCollectorCircuitBreakerState {
  constructor(filterConfig = {}) {
    this.layerName = 'telemetry_collector';
    this.filterType = 'CircuitBreakerState';
...
module.exports = { TelemetryCollectorCircuitBreakerState };
