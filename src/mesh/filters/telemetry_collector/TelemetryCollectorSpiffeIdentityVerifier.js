/**
 * TelemetryCollectorSpiffeIdentityVerifier.js
 * Envoy / eBPF Sidecar Telemetry Filter for telemetry_collector -> SpiffeIdentityVerifier
 */

class TelemetryCollectorSpiffeIdentityVerifier {
  constructor(filterConfig = {}) {
    this.layerName = 'telemetry_collector';
    this.filterType = 'SpiffeIdentityVerifier';
...
module.exports = { TelemetryCollectorSpiffeIdentityVerifier };
