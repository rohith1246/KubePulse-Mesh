/**
 * TelemetryCollectorTlsHandshakeMonitor.js
 * Envoy / eBPF Sidecar Telemetry Filter for telemetry_collector -> TlsHandshakeMonitor
 */

class TelemetryCollectorTlsHandshakeMonitor {
  constructor(filterConfig = {}) {
    this.layerName = 'telemetry_collector';
    this.filterType = 'TlsHandshakeMonitor';
...
module.exports = { TelemetryCollectorTlsHandshakeMonitor };
