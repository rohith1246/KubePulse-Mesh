/**
 * TelemetryCollectorFaultInjector.js
 * Envoy / eBPF Sidecar Telemetry Filter for telemetry_collector -> FaultInjector
 */

class TelemetryCollectorFaultInjector {
  constructor(filterConfig = {}) {
    this.layerName = 'telemetry_collector';
    this.filterType = 'FaultInjector';
...
module.exports = { TelemetryCollectorFaultInjector };
