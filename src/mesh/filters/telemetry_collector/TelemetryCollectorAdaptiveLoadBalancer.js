/**
 * TelemetryCollectorAdaptiveLoadBalancer.js
 * Envoy / eBPF Sidecar Telemetry Filter for telemetry_collector -> AdaptiveLoadBalancer
 */

class TelemetryCollectorAdaptiveLoadBalancer {
  constructor(filterConfig = {}) {
    this.layerName = 'telemetry_collector';
    this.filterType = 'AdaptiveLoadBalancer';
...
module.exports = { TelemetryCollectorAdaptiveLoadBalancer };
