/**
 * TelemetryCollectorMetricsPrometheusExporter.js
 * Envoy / eBPF Sidecar Telemetry Filter for telemetry_collector -> MetricsPrometheusExporter
 */

class TelemetryCollectorMetricsPrometheusExporter {
  constructor(filterConfig = {}) {
    this.layerName = 'telemetry_collector';
    this.filterType = 'MetricsPrometheusExporter';
...
module.exports = { TelemetryCollectorMetricsPrometheusExporter };
