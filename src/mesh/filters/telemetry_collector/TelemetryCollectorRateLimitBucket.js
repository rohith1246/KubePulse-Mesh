/**
 * TelemetryCollectorRateLimitBucket.js
 * Envoy / eBPF Sidecar Telemetry Filter for telemetry_collector -> RateLimitBucket
 */

class TelemetryCollectorRateLimitBucket {
...
module.exports = { TelemetryCollectorRateLimitBucket };
