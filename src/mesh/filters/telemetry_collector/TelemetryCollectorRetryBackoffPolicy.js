/**
 * TelemetryCollectorRetryBackoffPolicy.js
 * Envoy / eBPF Sidecar Telemetry Filter for telemetry_collector -> RetryBackoffPolicy
 */

class TelemetryCollectorRetryBackoffPolicy {
  constructor(filterConfig = {}) {
    this.layerName = 'telemetry_collector';
    this.filterType = 'RetryBackoffPolicy';
...
module.exports = { TelemetryCollectorRetryBackoffPolicy };
