/**
 * TelemetryCollectorLatencyHistogram.js
 * Envoy / eBPF Sidecar Telemetry Filter for telemetry_collector -> LatencyHistogram
 */

class TelemetryCollectorLatencyHistogram {
  constructor(filterConfig = {}) {
    this.layerName = 'telemetry_collector';
    this.filterType = 'LatencyHistogram';
...
module.exports = { TelemetryCollectorLatencyHistogram };
