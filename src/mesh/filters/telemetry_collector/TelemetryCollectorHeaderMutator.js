/**
 * TelemetryCollectorHeaderMutator.js
 * Envoy / eBPF Sidecar Telemetry Filter for telemetry_collector -> HeaderMutator
 */

class TelemetryCollectorHeaderMutator {
  constructor(filterConfig = {}) {
    this.layerName = 'telemetry_collector';
    this.filterType = 'HeaderMutator';
...
module.exports = { TelemetryCollectorHeaderMutator };
