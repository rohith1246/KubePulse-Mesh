 ...
 * Envoy / eBPF Sidecar Telemetry Filter for telemetry_collector -> HealthCheckPoller
 */

class TelemetryCollectorHealthCheckPoller {
...
module.exports = { TelemetryCollectorHealthCheckPoller };
