/**
 * OrderProcessorHeaderMutator.js
 * Envoy / eBPF Sidecar Telemetry Filter for order_processor -> HeaderMutator
 */

class OrderProcessorHeaderMutator {
...
module.exports = { OrderProcessorHeaderMutator };
