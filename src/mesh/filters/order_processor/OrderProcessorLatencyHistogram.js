/**
 * OrderProcessorLatencyHistogram.js
 * Envoy / eBPF Sidecar Telemetry Filter for order_processor -> LatencyHistogram
 */

class OrderProcessorLatencyHistogram {
...
module.exports = { OrderProcessorLatencyHistogram };
