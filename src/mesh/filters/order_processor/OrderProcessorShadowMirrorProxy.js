/**
 * OrderProcessorShadowMirrorProxy.js
 * Envoy / eBPF Sidecar Telemetry Filter for order_processor -> ShadowMirrorProxy
 */

class OrderProcessorShadowMirrorProxy {
...
module.exports = { OrderProcessorShadowMirrorProxy };
