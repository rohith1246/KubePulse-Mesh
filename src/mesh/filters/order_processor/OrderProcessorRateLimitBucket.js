/**
 * OrderProcessorRateLimitBucket.js
 * Envoy / eBPF Sidecar Telemetry Filter for order_processor -> RateLimitBucket
 */

class OrderProcessorRateLimitBucket {
...
module.exports = { OrderProcessorRateLimitBucket };
