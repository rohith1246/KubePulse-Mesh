/**
 * OrderProcessorCanaryTrafficSplitter.js
 * Envoy / eBPF Sidecar Telemetry Filter for order_processor -> CanaryTrafficSplitter
 */

class OrderProcessorCanaryTrafficSplitter {
...
module.exports = { OrderProcessorCanaryTrafficSplitter };
