/**
 * OrderProcessorPayloadCompressor.js
 * Envoy / eBPF Sidecar Telemetry Filter for order_processor -> PayloadCompressor
 */

class OrderProcessorPayloadCompressor {
...
module.exports = { OrderProcessorPayloadCompressor };
