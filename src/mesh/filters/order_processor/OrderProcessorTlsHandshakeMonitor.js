/**
 * OrderProcessorTlsHandshakeMonitor.js
 * Envoy / eBPF Sidecar Telemetry Filter for order_processor -> TlsHandshakeMonitor
 */

class OrderProcessorTlsHandshakeMonitor {
...
module.exports = { OrderProcessorTlsHandshakeMonitor };
