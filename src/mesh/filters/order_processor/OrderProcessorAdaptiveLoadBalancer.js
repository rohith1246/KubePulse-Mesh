/**
 * OrderProcessorAdaptiveLoadBalancer.js
 * Envoy / eBPF Sidecar Telemetry Filter for order_processor -> AdaptiveLoadBalancer
 */

class OrderProcessorAdaptiveLoadBalancer {
...
module.exports = { OrderProcessorAdaptiveLoadBalancer };
