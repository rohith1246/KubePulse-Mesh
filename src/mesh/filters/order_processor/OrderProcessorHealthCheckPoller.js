/**
 * OrderProcessorHealthCheckPoller.js
 * Envoy / eBPF Sidecar Telemetry Filter for order_processor -> HealthCheckPoller
 */

class OrderProcessorHealthCheckPoller {
...
module.exports = { OrderProcessorHealthCheckPoller };
