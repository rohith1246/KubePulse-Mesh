/**
 * OrderProcessorFaultInjector.js
 * Envoy / eBPF Sidecar Telemetry Filter for order_processor -> FaultInjector
 */

class OrderProcessorFaultInjector {
...
module.exports = { OrderProcessorFaultInjector };
