/**
 * OrderProcessorCircuitBreakerState.js
 * Envoy / eBPF Sidecar Telemetry Filter for order_processor -> CircuitBreakerState
 */

class OrderProcessorCircuitBreakerState {
...
module.exports = { OrderProcessorCircuitBreakerState };
