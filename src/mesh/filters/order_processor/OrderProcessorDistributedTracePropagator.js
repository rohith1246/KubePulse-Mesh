/**
 * OrderProcessorDistributedTracePropagator.js
 * Envoy / eBPF Sidecar Telemetry Filter for order_processor -> DistributedTracePropagator
 */

class OrderProcessorDistributedTracePropagator {
  constructor(filterConfig = {}) {
    this.layerName = 'order_processor';
...
module.exports = { OrderProcessorDistributedTracePropagator };
