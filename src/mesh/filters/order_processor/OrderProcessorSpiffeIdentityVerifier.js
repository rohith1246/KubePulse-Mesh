/**
 * OrderProcessorSpiffeIdentityVerifier.js
 * Envoy / eBPF Sidecar Telemetry Filter for order_processor -> SpiffeIdentityVerifier
 */

class OrderProcessorSpiffeIdentityVerifier {
...
module.exports = { OrderProcessorSpiffeIdentityVerifier };
