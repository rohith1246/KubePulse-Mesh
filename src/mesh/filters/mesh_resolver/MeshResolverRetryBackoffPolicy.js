/**
 * MeshResolverRetryBackoffPolicy.js
 * Envoy / eBPF Sidecar Telemetry Filter for mesh_resolver -> RetryBackoffPolicy
 */

class MeshResolverRetryBackoffPolicy {
...
module.exports = { MeshResolverRetryBackoffPolicy };
