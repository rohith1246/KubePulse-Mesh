/**
 * MeshResolverFaultInjector.js
 * Envoy / eBPF Sidecar Telemetry Filter for mesh_resolver -> FaultInjector
 */

class MeshResolverFaultInjector {
...
module.exports = { MeshResolverFaultInjector };
