/**
 * MeshResolverCircuitBreakerState.js
 * Envoy / eBPF Sidecar Telemetry Filter for mesh_resolver -> CircuitBreakerState
 */

class MeshResolverCircuitBreakerState {
...
module.exports = { MeshResolverCircuitBreakerState };
