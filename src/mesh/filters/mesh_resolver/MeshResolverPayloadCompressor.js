/**
 * MeshResolverPayloadCompressor.js
 * Envoy / eBPF Sidecar Telemetry Filter for mesh_resolver -> PayloadCompressor
 */

class MeshResolverPayloadCompressor {
...
module.exports = { MeshResolverPayloadCompressor };
