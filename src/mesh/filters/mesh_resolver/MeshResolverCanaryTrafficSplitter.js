/**
 * MeshResolverCanaryTrafficSplitter.js
 * Envoy / eBPF Sidecar Telemetry Filter for mesh_resolver -> CanaryTrafficSplitter
 */

class MeshResolverCanaryTrafficSplitter {
...
module.exports = { MeshResolverCanaryTrafficSplitter };
