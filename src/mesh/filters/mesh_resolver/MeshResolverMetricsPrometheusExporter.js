/**
 * MeshResolverMetricsPrometheusExporter.js
 * Envoy / eBPF Sidecar Telemetry Filter for mesh_resolver -> MetricsPrometheusExporter
 */

class MeshResolverMetricsPrometheusExporter {
...
module.exports = { MeshResolverMetricsPrometheusExporter };
