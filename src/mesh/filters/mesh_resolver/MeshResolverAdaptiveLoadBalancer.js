/**
 * MeshResolverAdaptiveLoadBalancer.js
 * Envoy / eBPF Sidecar Telemetry Filter for mesh_resolver -> AdaptiveLoadBalancer
 */

class MeshResolverAdaptiveLoadBalancer {
...
module.exports = { MeshResolverAdaptiveLoadBalancer };
