/**
 * MeshResolverSpiffeIdentityVerifier.js
 * Envoy / eBPF Sidecar Telemetry Filter for mesh_resolver -> SpiffeIdentityVerifier
 */

class MeshResolverSpiffeIdentityVerifier {
...
module.exports = { MeshResolverSpiffeIdentityVerifier };
