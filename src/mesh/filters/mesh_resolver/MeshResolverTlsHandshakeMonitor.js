/**
 * MeshResolverTlsHandshakeMonitor.js
 * Envoy / eBPF Sidecar Telemetry Filter for mesh_resolver -> TlsHandshakeMonitor
 */

class MeshResolverTlsHandshakeMonitor {
...
module.exports = { MeshResolverTlsHandshakeMonitor };
