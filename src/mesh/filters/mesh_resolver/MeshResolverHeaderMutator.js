/**
 * MeshResolverHeaderMutator.js
 * Envoy / eBPF Sidecar Telemetry Filter for mesh_resolver -> HeaderMutator
 */

class MeshResolverHeaderMutator {
...
module.exports = { MeshResolverHeaderMutator };
