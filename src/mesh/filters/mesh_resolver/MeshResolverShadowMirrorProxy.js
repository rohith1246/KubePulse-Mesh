/**
 * MeshResolverShadowMirrorProxy.js
 * Envoy / eBPF Sidecar Telemetry Filter for mesh_resolver -> ShadowMirrorProxy
 */

class MeshResolverShadowMirrorProxy {
...
module.exports = { MeshResolverShadowMirrorProxy };
