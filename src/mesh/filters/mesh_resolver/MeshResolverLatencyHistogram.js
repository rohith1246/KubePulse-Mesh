/**
 * MeshResolverLatencyHistogram.js
 * Envoy / eBPF Sidecar Telemetry Filter for mesh_resolver -> LatencyHistogram
 */

class MeshResolverLatencyHistogram {
...
module.exports = { MeshResolverLatencyHistogram };
