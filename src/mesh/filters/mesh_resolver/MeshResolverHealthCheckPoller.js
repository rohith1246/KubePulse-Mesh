/**
 * MeshResolverHealthCheckPoller.js
 * Envoy / eBPF Sidecar Telemetry Filter for mesh_resolver -> HealthCheckPoller
 */

class MeshResolverHealthCheckPoller {
...
module.exports = { MeshResolverHealthCheckPoller };
