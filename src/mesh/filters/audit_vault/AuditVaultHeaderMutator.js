/**
 * AuditVaultHeaderMutator.js
 * Envoy / eBPF Sidecar Telemetry Filter for audit_vault -> HeaderMutator
 */

class AuditVaultHeaderMutator {
...
module.exports = { AuditVaultHeaderMutator };
