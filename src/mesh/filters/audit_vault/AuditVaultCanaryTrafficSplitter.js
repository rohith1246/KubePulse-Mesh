/**
 * AuditVaultCanaryTrafficSplitter.js
 * Envoy / eBPF Sidecar Telemetry Filter for audit_vault -> CanaryTrafficSplitter
 */

class AuditVaultCanaryTrafficSplitter {
...
module.exports = { AuditVaultCanaryTrafficSplitter };
