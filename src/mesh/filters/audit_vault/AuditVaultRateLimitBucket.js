/**
 * AuditVaultRateLimitBucket.js
 * Envoy / eBPF Sidecar Telemetry Filter for audit_vault -> RateLimitBucket
 */

class AuditVaultRateLimitBucket {
...
module.exports = { AuditVaultRateLimitBucket };
