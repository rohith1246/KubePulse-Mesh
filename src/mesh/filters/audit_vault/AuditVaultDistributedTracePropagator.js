/**
 * AuditVaultDistributedTracePropagator.js
 * Envoy / eBPF Sidecar Telemetry Filter for audit_vault -> DistributedTracePropagator
 */

class AuditVaultDistributedTracePropagator {
  constructor(filterConfig = {}) {
    this.layerName = 'audit_vault';
...
module.exports = { AuditVaultDistributedTracePropagator };
