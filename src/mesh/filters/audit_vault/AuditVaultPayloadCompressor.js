/**
 * AuditVaultPayloadCompressor.js
 * Envoy / eBPF Sidecar Telemetry Filter for audit_vault -> PayloadCompressor
 */

class AuditVaultPayloadCompressor {
...
module.exports = { AuditVaultPayloadCompressor };
