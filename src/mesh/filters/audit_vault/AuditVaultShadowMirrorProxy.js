/**
 * AuditVaultShadowMirrorProxy.js
 * Envoy / eBPF Sidecar Telemetry Filter for audit_vault -> ShadowMirrorProxy
 */

class AuditVaultShadowMirrorProxy {
...
module.exports = { AuditVaultShadowMirrorProxy };
