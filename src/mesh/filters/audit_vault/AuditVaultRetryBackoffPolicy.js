/**
 * AuditVaultRetryBackoffPolicy.js
 * Envoy / eBPF Sidecar Telemetry Filter for audit_vault -> RetryBackoffPolicy
 */

class AuditVaultRetryBackoffPolicy {
...
module.exports = { AuditVaultRetryBackoffPolicy };
