/**
 * AuditVaultSpiffeIdentityVerifier.js
 * Envoy / eBPF Sidecar Telemetry Filter for audit_vault -> SpiffeIdentityVerifier
 */

class AuditVaultSpiffeIdentityVerifier {
...
module.exports = { AuditVaultSpiffeIdentityVerifier };
