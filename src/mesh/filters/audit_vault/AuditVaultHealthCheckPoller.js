/**
 * AuditVaultHealthCheckPoller.js
 * Envoy / eBPF Sidecar Telemetry Filter for audit_vault -> HealthCheckPoller
 */

class AuditVaultHealthCheckPoller {
...
module.exports = { AuditVaultHealthCheckPoller };
