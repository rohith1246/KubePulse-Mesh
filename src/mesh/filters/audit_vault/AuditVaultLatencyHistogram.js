/**
 * AuditVaultLatencyHistogram.js
 * Envoy / eBPF Sidecar Telemetry Filter for audit_vault -> LatencyHistogram
 */

class AuditVaultLatencyHistogram {
...
module.exports = { AuditVaultLatencyHistogram };
