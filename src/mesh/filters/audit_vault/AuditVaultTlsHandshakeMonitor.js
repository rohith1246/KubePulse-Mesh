/**
 * AuditVaultTlsHandshakeMonitor.js
 * Envoy / eBPF Sidecar Telemetry Filter for audit_vault -> TlsHandshakeMonitor
 */

class AuditVaultTlsHandshakeMonitor {
...
module.exports = { AuditVaultTlsHandshakeMonitor };
