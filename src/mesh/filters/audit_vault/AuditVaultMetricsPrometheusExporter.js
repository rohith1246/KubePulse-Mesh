/**
 * AuditVaultMetricsPrometheusExporter.js
 * Envoy / eBPF Sidecar Telemetry Filter for audit_vault -> MetricsPrometheusExporter
 */

class AuditVaultMetricsPrometheusExporter {
...
module.exports = { AuditVaultMetricsPrometheusExporter };
