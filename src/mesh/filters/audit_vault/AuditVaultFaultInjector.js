/**
 * AuditVaultFaultInjector.js
 * Envoy / eBPF Sidecar Telemetry Filter for audit_vault -> FaultInjector
 */

class AuditVaultFaultInjector {
...
module.exports = { AuditVaultFaultInjector };
