/**
 * AuditVaultCircuitBreakerState.js
 * Envoy / eBPF Sidecar Telemetry Filter for audit_vault -> CircuitBreakerState
 */

class AuditVaultCircuitBreakerState {
...
module.exports = { AuditVaultCircuitBreakerState };
