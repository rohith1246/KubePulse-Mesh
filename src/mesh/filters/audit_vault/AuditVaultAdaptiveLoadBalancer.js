/**
 * AuditVaultAdaptiveLoadBalancer.js
 * Envoy / eBPF Sidecar Telemetry Filter for audit_vault -> AdaptiveLoadBalancer
 */

class AuditVaultAdaptiveLoadBalancer {
...
module.exports = { AuditVaultAdaptiveLoadBalancer };
