/**
 * AuthProxyLatencyHistogram.js
 * Envoy / eBPF Sidecar Telemetry Filter for auth_proxy -> LatencyHistogram
 */

class AuthProxyLatencyHistogram {
...
module.exports = { AuthProxyLatencyHistogram };
