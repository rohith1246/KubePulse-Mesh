/**
 * AuthProxyMetricsPrometheusExporter.js
 * Envoy / eBPF Sidecar Telemetry Filter for auth_proxy -> MetricsPrometheusExporter
 */

class AuthProxyMetricsPrometheusExporter {
...
module.exports = { AuthProxyMetricsPrometheusExporter };
