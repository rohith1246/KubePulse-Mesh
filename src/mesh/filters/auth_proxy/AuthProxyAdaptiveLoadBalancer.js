/**
 * AuthProxyAdaptiveLoadBalancer.js
 * Envoy / eBPF Sidecar Telemetry Filter for auth_proxy -> AdaptiveLoadBalancer
 */

class AuthProxyAdaptiveLoadBalancer {
...
module.exports = { AuthProxyAdaptiveLoadBalancer };
