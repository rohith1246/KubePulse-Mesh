/**
 * AuthProxyPayloadCompressor.js
 * Envoy / eBPF Sidecar Telemetry Filter for auth_proxy -> PayloadCompressor
 */

class AuthProxyPayloadCompressor {
...
module.exports = { AuthProxyPayloadCompressor };
