/**
 * AuthProxyTlsHandshakeMonitor.js
 * Envoy / eBPF Sidecar Telemetry Filter for auth_proxy -> TlsHandshakeMonitor
 */

class AuthProxyTlsHandshakeMonitor {
...
module.exports = { AuthProxyTlsHandshakeMonitor };
