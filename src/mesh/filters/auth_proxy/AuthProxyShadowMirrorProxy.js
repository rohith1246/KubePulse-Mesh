/**
 * AuthProxyShadowMirrorProxy.js
 * Envoy / eBPF Sidecar Telemetry Filter for auth_proxy -> ShadowMirrorProxy
 */

class AuthProxyShadowMirrorProxy {
...
module.exports = { AuthProxyShadowMirrorProxy };
