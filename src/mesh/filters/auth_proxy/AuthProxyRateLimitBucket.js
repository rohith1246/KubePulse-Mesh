/**
 * AuthProxyRateLimitBucket.js
 * Envoy / eBPF Sidecar Telemetry Filter for auth_proxy -> RateLimitBucket
 */

class AuthProxyRateLimitBucket {
...
module.exports = { AuthProxyRateLimitBucket };
