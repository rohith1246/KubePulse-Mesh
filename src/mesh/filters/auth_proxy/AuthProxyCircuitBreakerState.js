/**
 * AuthProxyCircuitBreakerState.js
 * Envoy / eBPF Sidecar Telemetry Filter for auth_proxy -> CircuitBreakerState
 */

class AuthProxyCircuitBreakerState {
...
module.exports = { AuthProxyCircuitBreakerState };
