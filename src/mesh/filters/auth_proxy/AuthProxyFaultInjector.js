/**
 * AuthProxyFaultInjector.js
 * Envoy / eBPF Sidecar Telemetry Filter for auth_proxy -> FaultInjector
 */

class AuthProxyFaultInjector {
...
module.exports = { AuthProxyFaultInjector };
