/**
 * AuthProxySpiffeIdentityVerifier.js
 * Envoy / eBPF Sidecar Telemetry Filter for auth_proxy -> SpiffeIdentityVerifier
 */

class AuthProxySpiffeIdentityVerifier {
...
module.exports = { AuthProxySpiffeIdentityVerifier };
