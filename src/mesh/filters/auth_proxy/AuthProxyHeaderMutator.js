/**
 * AuthProxyHeaderMutator.js
 * Envoy / eBPF Sidecar Telemetry Filter for auth_proxy -> HeaderMutator
 */

class AuthProxyHeaderMutator {
...
module.exports = { AuthProxyHeaderMutator };
