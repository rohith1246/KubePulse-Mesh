/**
 * AuthProxyDistributedTracePropagator.js
 * Envoy / eBPF Sidecar Telemetry Filter for auth_proxy -> DistributedTracePropagator
 */

class AuthProxyDistributedTracePropagator {
  constructor(filterConfig = {}) {
    this.layerName = 'auth_proxy';
...
module.exports = { AuthProxyDistributedTracePropagator };
