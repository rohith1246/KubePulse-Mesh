/**
 * AuthProxyRetryBackoffPolicy.js
 * Envoy / eBPF Sidecar Telemetry Filter for auth_proxy -> RetryBackoffPolicy
 */

class AuthProxyRetryBackoffPolicy {
...
module.exports = { AuthProxyRetryBackoffPolicy };
