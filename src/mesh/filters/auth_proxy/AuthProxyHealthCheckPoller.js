/**
 * AuthProxyHealthCheckPoller.js
 * Envoy / eBPF Sidecar Telemetry Filter for auth_proxy -> HealthCheckPoller
 */

class AuthProxyHealthCheckPoller {
...
module.exports = { AuthProxyHealthCheckPoller };
