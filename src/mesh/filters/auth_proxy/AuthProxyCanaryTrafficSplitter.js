/**
 * AuthProxyCanaryTrafficSplitter.js
 * Envoy / eBPF Sidecar Telemetry Filter for auth_proxy -> CanaryTrafficSplitter
 */

class AuthProxyCanaryTrafficSplitter {
...
module.exports = { AuthProxyCanaryTrafficSplitter };
