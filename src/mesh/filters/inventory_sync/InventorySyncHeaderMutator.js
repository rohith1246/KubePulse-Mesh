/**
 * InventorySyncHeaderMutator.js
 * Envoy / eBPF Sidecar Telemetry Filter for inventory_sync -> HeaderMutator
 */

class InventorySyncHeaderMutator {
...
module.exports = { InventorySyncHeaderMutator };
