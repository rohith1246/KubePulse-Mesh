/**
 * InventorySyncShadowMirrorProxy.js
 * Envoy / eBPF Sidecar Telemetry Filter for inventory_sync -> ShadowMirrorProxy
 */

class InventorySyncShadowMirrorProxy {
...
module.exports = { InventorySyncShadowMirrorProxy };
