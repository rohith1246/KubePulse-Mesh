/**
 * InventorySyncRetryBackoffPolicy.js
 * Envoy / eBPF Sidecar Telemetry Filter for inventory_sync -> RetryBackoffPolicy
 */

class InventorySyncRetryBackoffPolicy {
...
module.exports = { InventorySyncRetryBackoffPolicy };
