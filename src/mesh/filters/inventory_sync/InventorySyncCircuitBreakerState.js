/**
 * InventorySyncCircuitBreakerState.js
 * Envoy / eBPF Sidecar Telemetry Filter for inventory_sync -> CircuitBreakerState
 */

class InventorySyncCircuitBreakerState {
...
module.exports = { InventorySyncCircuitBreakerState };
