/**
 * InventorySyncTlsHandshakeMonitor.js
 * Envoy / eBPF Sidecar Telemetry Filter for inventory_sync -> TlsHandshakeMonitor
 */

class InventorySyncTlsHandshakeMonitor {
...
module.exports = { InventorySyncTlsHandshakeMonitor };
