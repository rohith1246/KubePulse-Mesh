/**
 * InventorySyncSpiffeIdentityVerifier.js
 * Envoy / eBPF Sidecar Telemetry Filter for inventory_sync -> SpiffeIdentityVerifier
 */

class InventorySyncSpiffeIdentityVerifier {
...
module.exports = { InventorySyncSpiffeIdentityVerifier };
