/**
 * InventorySyncRateLimitBucket.js
 * Envoy / eBPF Sidecar Telemetry Filter for inventory_sync -> RateLimitBucket
 */

class InventorySyncRateLimitBucket {
...
module.exports = { InventorySyncRateLimitBucket };
