/**
 * InventorySyncAdaptiveLoadBalancer.js
 * Envoy / eBPF Sidecar Telemetry Filter for inventory_sync -> AdaptiveLoadBalancer
 */

class InventorySyncAdaptiveLoadBalancer {
...
module.exports = { InventorySyncAdaptiveLoadBalancer };
