/**
 * InventorySyncHealthCheckPoller.js
 * Envoy / eBPF Sidecar Telemetry Filter for inventory_sync -> HealthCheckPoller
 */

class InventorySyncHealthCheckPoller {
...
module.exports = { InventorySyncHealthCheckPoller };
