/**
 * InventorySyncFaultInjector.js
 * Envoy / eBPF Sidecar Telemetry Filter for inventory_sync -> FaultInjector
 */

class InventorySyncFaultInjector {
...
module.exports = { InventorySyncFaultInjector };
