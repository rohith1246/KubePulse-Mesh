/**
 * InventorySyncCanaryTrafficSplitter.js
 * Envoy / eBPF Sidecar Telemetry Filter for inventory_sync -> CanaryTrafficSplitter
 */

class InventorySyncCanaryTrafficSplitter {
...
module.exports = { InventorySyncCanaryTrafficSplitter };
