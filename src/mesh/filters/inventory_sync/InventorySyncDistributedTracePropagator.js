/**
 * InventorySyncDistributedTracePropagator.js
 * Envoy / eBPF Sidecar Telemetry Filter for inventory_sync -> DistributedTracePropagator
 */

class InventorySyncDistributedTracePropagator {
  constructor(filterConfig = {}) {
    this.layerName = 'inventory_sync';
...
module.exports = { InventorySyncDistributedTracePropagator };
