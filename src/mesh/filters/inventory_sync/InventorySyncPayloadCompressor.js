/**
 * InventorySyncPayloadCompressor.js
 * Envoy / eBPF Sidecar Telemetry Filter for inventory_sync -> PayloadCompressor
 */

class InventorySyncPayloadCompressor {
...
module.exports = { InventorySyncPayloadCompressor };
