/**
 * InventorySyncLatencyHistogram.js
 * Envoy / eBPF Sidecar Telemetry Filter for inventory_sync -> LatencyHistogram
 */

class InventorySyncLatencyHistogram {
...
module.exports = { InventorySyncLatencyHistogram };
