/**
 * RateGuardHeaderMutator.js
 * Envoy / eBPF Sidecar Telemetry Filter for rate_guard -> HeaderMutator
 */

class RateGuardHeaderMutator {
...
module.exports = { RateGuardHeaderMutator };
