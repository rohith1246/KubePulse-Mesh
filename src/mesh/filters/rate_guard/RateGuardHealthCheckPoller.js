/**
 * RateGuardHealthCheckPoller.js
 * Envoy / eBPF Sidecar Telemetry Filter for rate_guard -> HealthCheckPoller
 */

class RateGuardHealthCheckPoller {
...
module.exports = { RateGuardHealthCheckPoller };
