/**
 * RateGuardShadowMirrorProxy.js
 * Envoy / eBPF Sidecar Telemetry Filter for rate_guard -> ShadowMirrorProxy
 */

class RateGuardShadowMirrorProxy {
...
module.exports = { RateGuardShadowMirrorProxy };
