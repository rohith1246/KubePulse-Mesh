/**
 * RateGuardMetricsPrometheusExporter.js
 * Envoy / eBPF Sidecar Telemetry Filter for rate_guard -> MetricsPrometheusExporter
 */

class RateGuardMetricsPrometheusExporter {
...
module.exports = { RateGuardMetricsPrometheusExporter };
