/**
 * RateGuardDistributedTracePropagator.js
 * Envoy / eBPF Sidecar Telemetry Filter for rate_guard -> DistributedTracePropagator
 */

class RateGuardDistributedTracePropagator {
  constructor(filterConfig = {}) {
    this.layerName = 'rate_guard';
...
module.exports = { RateGuardDistributedTracePropagator };
