/**
 * RateGuardAdaptiveLoadBalancer.js
 * Envoy / eBPF Sidecar Telemetry Filter for rate_guard -> AdaptiveLoadBalancer
 */

class RateGuardAdaptiveLoadBalancer {
...
module.exports = { RateGuardAdaptiveLoadBalancer };
