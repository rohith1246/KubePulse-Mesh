/**
 * RateGuardCircuitBreakerState.js
 * Envoy / eBPF Sidecar Telemetry Filter for rate_guard -> CircuitBreakerState
 */

class RateGuardCircuitBreakerState {
...
module.exports = { RateGuardCircuitBreakerState };
