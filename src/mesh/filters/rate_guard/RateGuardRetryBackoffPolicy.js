/**
 * RateGuardRetryBackoffPolicy.js
 * Envoy / eBPF Sidecar Telemetry Filter for rate_guard -> RetryBackoffPolicy
 */

class RateGuardRetryBackoffPolicy {
...
module.exports = { RateGuardRetryBackoffPolicy };
