/**
 * RateGuardTlsHandshakeMonitor.js
 * Envoy / eBPF Sidecar Telemetry Filter for rate_guard -> TlsHandshakeMonitor
 */

class RateGuardTlsHandshakeMonitor {
...
module.exports = { RateGuardTlsHandshakeMonitor };
