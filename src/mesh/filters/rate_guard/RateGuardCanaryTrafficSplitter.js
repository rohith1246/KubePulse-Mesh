/**
 * RateGuardCanaryTrafficSplitter.js
 * Envoy / eBPF Sidecar Telemetry Filter for rate_guard -> CanaryTrafficSplitter
 */

class RateGuardCanaryTrafficSplitter {
...
module.exports = { RateGuardCanaryTrafficSplitter };
