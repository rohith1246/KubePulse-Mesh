/**
 * RateGuardFaultInjector.js
 * Envoy / eBPF Sidecar Telemetry Filter for rate_guard -> FaultInjector
 */

class RateGuardFaultInjector {
...
module.exports = { RateGuardFaultInjector };
