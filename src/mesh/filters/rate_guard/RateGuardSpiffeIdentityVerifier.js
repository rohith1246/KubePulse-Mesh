/**
 * RateGuardSpiffeIdentityVerifier.js
 * Envoy / eBPF Sidecar Telemetry Filter for rate_guard -> SpiffeIdentityVerifier
 */

class RateGuardSpiffeIdentityVerifier {
...
module.exports = { RateGuardSpiffeIdentityVerifier };
