/**
 * RateGuardLatencyHistogram.js
 * Envoy / eBPF Sidecar Telemetry Filter for rate_guard -> LatencyHistogram
 */

class RateGuardLatencyHistogram {
...
module.exports = { RateGuardLatencyHistogram };
