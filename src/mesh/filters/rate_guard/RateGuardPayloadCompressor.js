/**
 * RateGuardPayloadCompressor.js
 * Envoy / eBPF Sidecar Telemetry Filter for rate_guard -> PayloadCompressor
 */

class RateGuardPayloadCompressor {
...
module.exports = { RateGuardPayloadCompressor };
