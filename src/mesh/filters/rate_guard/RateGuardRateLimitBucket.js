/**
 * RateGuardRateLimitBucket.js
 * Envoy / eBPF Sidecar Telemetry Filter for rate_guard -> RateLimitBucket
 */

class RateGuardRateLimitBucket {
...
module.exports = { RateGuardRateLimitBucket };
