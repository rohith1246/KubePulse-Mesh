/**
 * EgressGatewayTlsHandshakeMonitor.js
 * Envoy / eBPF Sidecar Telemetry Filter for egress_gateway -> TlsHandshakeMonitor
 */

class EgressGatewayTlsHandshakeMonitor {
...
module.exports = { EgressGatewayTlsHandshakeMonitor };
