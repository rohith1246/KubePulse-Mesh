/**
 * EgressGatewayLatencyHistogram.js
 * Envoy / eBPF Sidecar Telemetry Filter for egress_gateway -> LatencyHistogram
 */

class EgressGatewayLatencyHistogram {
...
module.exports = { EgressGatewayLatencyHistogram };
