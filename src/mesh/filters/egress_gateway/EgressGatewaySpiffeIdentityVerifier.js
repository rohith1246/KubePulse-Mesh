/**
 * EgressGatewaySpiffeIdentityVerifier.js
 * Envoy / eBPF Sidecar Telemetry Filter for egress_gateway -> SpiffeIdentityVerifier
 */

class EgressGatewaySpiffeIdentityVerifier {
...
module.exports = { EgressGatewaySpiffeIdentityVerifier };
