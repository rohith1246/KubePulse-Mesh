/**
 * EgressGatewayHeaderMutator.js
 * Envoy / eBPF Sidecar Telemetry Filter for egress_gateway -> HeaderMutator
 */

class EgressGatewayHeaderMutator {
...
module.exports = { EgressGatewayHeaderMutator };
