/**
 * EgressGatewayCanaryTrafficSplitter.js
 * Envoy / eBPF Sidecar Telemetry Filter for egress_gateway -> CanaryTrafficSplitter
 */

class EgressGatewayCanaryTrafficSplitter {
...
module.exports = { EgressGatewayCanaryTrafficSplitter };
