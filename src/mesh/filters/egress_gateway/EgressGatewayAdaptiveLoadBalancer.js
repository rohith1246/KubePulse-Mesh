/**
 * EgressGatewayAdaptiveLoadBalancer.js
 * Envoy / eBPF Sidecar Telemetry Filter for egress_gateway -> AdaptiveLoadBalancer
 */

class EgressGatewayAdaptiveLoadBalancer {
...
module.exports = { EgressGatewayAdaptiveLoadBalancer };
