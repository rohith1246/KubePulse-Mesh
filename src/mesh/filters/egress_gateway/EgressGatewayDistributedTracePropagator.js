/**
 * EgressGatewayDistributedTracePropagator.js
 * Envoy / eBPF Sidecar Telemetry Filter for egress_gateway -> DistributedTracePropagator
 */

class EgressGatewayDistributedTracePropagator {
  constructor(filterConfig = {}) {
    this.layerName = 'egress_gateway';
...
module.exports = { EgressGatewayDistributedTracePropagator };
