/**
 * EgressGatewayCircuitBreakerState.js
 * Envoy / eBPF Sidecar Telemetry Filter for egress_gateway -> CircuitBreakerState
 */

class EgressGatewayCircuitBreakerState {
...
module.exports = { EgressGatewayCircuitBreakerState };
