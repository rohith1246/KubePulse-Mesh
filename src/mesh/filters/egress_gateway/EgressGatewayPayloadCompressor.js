/**
 * EgressGatewayPayloadCompressor.js
 * Envoy / eBPF Sidecar Telemetry Filter for egress_gateway -> PayloadCompressor
 */

class EgressGatewayPayloadCompressor {
...
module.exports = { EgressGatewayPayloadCompressor };
