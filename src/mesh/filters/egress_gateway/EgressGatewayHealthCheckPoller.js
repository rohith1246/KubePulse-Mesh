/**
 * EgressGatewayHealthCheckPoller.js
 * Envoy / eBPF Sidecar Telemetry Filter for egress_gateway -> HealthCheckPoller
 */

class EgressGatewayHealthCheckPoller {
...
module.exports = { EgressGatewayHealthCheckPoller };
