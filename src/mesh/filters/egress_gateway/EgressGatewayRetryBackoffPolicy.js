/**
 * EgressGatewayRetryBackoffPolicy.js
 * Envoy / eBPF Sidecar Telemetry Filter for egress_gateway -> RetryBackoffPolicy
 */

class EgressGatewayRetryBackoffPolicy {
...
module.exports = { EgressGatewayRetryBackoffPolicy };
