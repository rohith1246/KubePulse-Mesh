/**
 * EgressGatewayFaultInjector.js
 * Envoy / eBPF Sidecar Telemetry Filter for egress_gateway -> FaultInjector
 */

class EgressGatewayFaultInjector {
...
module.exports = { EgressGatewayFaultInjector };
