/**
 * EgressGatewayRateLimitBucket.js
 * Envoy / eBPF Sidecar Telemetry Filter for egress_gateway -> RateLimitBucket
 */

class EgressGatewayRateLimitBucket {
...
module.exports = { EgressGatewayRateLimitBucket };
