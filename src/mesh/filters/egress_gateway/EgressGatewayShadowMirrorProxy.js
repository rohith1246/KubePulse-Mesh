/**
 * EgressGatewayShadowMirrorProxy.js
 * Envoy / eBPF Sidecar Telemetry Filter for egress_gateway -> ShadowMirrorProxy
 */

class EgressGatewayShadowMirrorProxy {
...
module.exports = { EgressGatewayShadowMirrorProxy };
