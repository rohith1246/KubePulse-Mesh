/**
 * SecretVaultAdaptiveLoadBalancer.js
 * Envoy / eBPF Sidecar Telemetry Filter for secret_vault -> AdaptiveLoadBalancer
 */

class SecretVaultAdaptiveLoadBalancer {
...
module.exports = { SecretVaultAdaptiveLoadBalancer };
