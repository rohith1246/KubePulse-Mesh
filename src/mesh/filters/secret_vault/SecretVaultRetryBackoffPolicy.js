/**
 * SecretVaultRetryBackoffPolicy.js
 * Envoy / eBPF Sidecar Telemetry Filter for secret_vault -> RetryBackoffPolicy
 */

class SecretVaultRetryBackoffPolicy {
...
module.exports = { SecretVaultRetryBackoffPolicy };
