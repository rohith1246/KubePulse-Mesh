/**
 * SecretVaultHealthCheckPoller.js
 * Envoy / eBPF Sidecar Telemetry Filter for secret_vault -> HealthCheckPoller
 */

class SecretVaultHealthCheckPoller {
...
module.exports = { SecretVaultHealthCheckPoller };
