/**
 * SecretVaultRateLimitBucket.js
 * Envoy / eBPF Sidecar Telemetry Filter for secret_vault -> RateLimitBucket
 */

class SecretVaultRateLimitBucket {
...
module.exports = { SecretVaultRateLimitBucket };
