/**
 * SecretVaultFaultInjector.js
 * Envoy / eBPF Sidecar Telemetry Filter for secret_vault -> FaultInjector
 */

class SecretVaultFaultInjector {
...
module.exports = { SecretVaultFaultInjector };
