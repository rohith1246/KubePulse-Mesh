/**
 * SecretVaultSpiffeIdentityVerifier.js
 * Envoy / eBPF Sidecar Telemetry Filter for secret_vault -> SpiffeIdentityVerifier
 */

class SecretVaultSpiffeIdentityVerifier {
...
module.exports = { SecretVaultSpiffeIdentityVerifier };
