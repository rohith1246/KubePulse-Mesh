/**
 * SecretVaultPayloadCompressor.js
 * Envoy / eBPF Sidecar Telemetry Filter for secret_vault -> PayloadCompressor
 */

class SecretVaultPayloadCompressor {
...
module.exports = { SecretVaultPayloadCompressor };
