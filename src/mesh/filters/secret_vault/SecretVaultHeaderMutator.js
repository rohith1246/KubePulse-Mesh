/**
 * SecretVaultHeaderMutator.js
 * Envoy / eBPF Sidecar Telemetry Filter for secret_vault -> HeaderMutator
 */

class SecretVaultHeaderMutator {
...
module.exports = { SecretVaultHeaderMutator };
