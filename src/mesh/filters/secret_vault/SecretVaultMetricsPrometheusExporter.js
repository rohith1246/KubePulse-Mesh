/**
 * SecretVaultMetricsPrometheusExporter.js
 * Envoy / eBPF Sidecar Telemetry Filter for secret_vault -> MetricsPrometheusExporter
 */

class SecretVaultMetricsPrometheusExporter {
...
module.exports = { SecretVaultMetricsPrometheusExporter };
