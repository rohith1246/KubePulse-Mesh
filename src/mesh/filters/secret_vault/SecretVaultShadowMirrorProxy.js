/**
 * SecretVaultShadowMirrorProxy.js
 * Envoy / eBPF Sidecar Telemetry Filter for secret_vault -> ShadowMirrorProxy
 */

class SecretVaultShadowMirrorProxy {
...
module.exports = { SecretVaultShadowMirrorProxy };
