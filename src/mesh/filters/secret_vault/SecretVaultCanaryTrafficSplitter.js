/**
 * SecretVaultCanaryTrafficSplitter.js
 * Envoy / eBPF Sidecar Telemetry Filter for secret_vault -> CanaryTrafficSplitter
 */

class SecretVaultCanaryTrafficSplitter {
...
module.exports = { SecretVaultCanaryTrafficSplitter };
