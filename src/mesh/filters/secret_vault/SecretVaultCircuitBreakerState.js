/**
 * SecretVaultCircuitBreakerState.js
 * Envoy / eBPF Sidecar Telemetry Filter for secret_vault -> CircuitBreakerState
 */

class SecretVaultCircuitBreakerState {
...
module.exports = { SecretVaultCircuitBreakerState };
