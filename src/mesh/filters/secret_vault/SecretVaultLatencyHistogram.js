/**
 * SecretVaultLatencyHistogram.js
 * Envoy / eBPF Sidecar Telemetry Filter for secret_vault -> LatencyHistogram
 */

class SecretVaultLatencyHistogram {
...
module.exports = { SecretVaultLatencyHistogram };
