/**
 * SecretVaultDistributedTracePropagator.js
 * Envoy / eBPF Sidecar Telemetry Filter for secret_vault -> DistributedTracePropagator
 */

class SecretVaultDistributedTracePropagator {
  constructor(filterConfig = {}) {
    this.layerName = 'secret_vault';
...
module.exports = { SecretVaultDistributedTracePropagator };
