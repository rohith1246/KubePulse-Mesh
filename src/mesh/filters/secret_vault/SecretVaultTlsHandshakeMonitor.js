/**
 * SecretVaultTlsHandshakeMonitor.js
 * Envoy / eBPF Sidecar Telemetry Filter for secret_vault -> TlsHandshakeMonitor
 */

class SecretVaultTlsHandshakeMonitor {
...
module.exports = { SecretVaultTlsHandshakeMonitor };
