/**
 * CatalogServiceCanaryTrafficSplitter.js
 * Envoy / eBPF Sidecar Telemetry Filter for catalog_service -> CanaryTrafficSplitter
 */

class CatalogServiceCanaryTrafficSplitter {
...
module.exports = { CatalogServiceCanaryTrafficSplitter };
