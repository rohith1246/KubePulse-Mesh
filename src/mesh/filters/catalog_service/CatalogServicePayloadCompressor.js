/**
 * CatalogServicePayloadCompressor.js
 * Envoy / eBPF Sidecar Telemetry Filter for catalog_service -> PayloadCompressor
 */

class CatalogServicePayloadCompressor {
...
module.exports = { CatalogServicePayloadCompressor };
