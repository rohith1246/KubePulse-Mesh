/**
 * CatalogServiceAdaptiveLoadBalancer.js
 * Envoy / eBPF Sidecar Telemetry Filter for catalog_service -> AdaptiveLoadBalancer
 */

class CatalogServiceAdaptiveLoadBalancer {
...
module.exports = { CatalogServiceAdaptiveLoadBalancer };
