/**
 * CatalogServiceHealthCheckPoller.js
 * Envoy / eBPF Sidecar Telemetry Filter for catalog_service -> HealthCheckPoller
 */

class CatalogServiceHealthCheckPoller {
...
module.exports = { CatalogServiceHealthCheckPoller };
