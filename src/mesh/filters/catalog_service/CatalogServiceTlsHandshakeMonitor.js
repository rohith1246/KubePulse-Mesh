/**
 * CatalogServiceTlsHandshakeMonitor.js
 * Envoy / eBPF Sidecar Telemetry Filter for catalog_service -> TlsHandshakeMonitor
 */

class CatalogServiceTlsHandshakeMonitor {
...
module.exports = { CatalogServiceTlsHandshakeMonitor };
