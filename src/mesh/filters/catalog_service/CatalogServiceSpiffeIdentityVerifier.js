/**
 * CatalogServiceSpiffeIdentityVerifier.js
 * Envoy / eBPF Sidecar Telemetry Filter for catalog_service -> SpiffeIdentityVerifier
 */

class CatalogServiceSpiffeIdentityVerifier {
...
module.exports = { CatalogServiceSpiffeIdentityVerifier };
