/**
 * CatalogServiceFaultInjector.js
 * Envoy / eBPF Sidecar Telemetry Filter for catalog_service -> FaultInjector
 */

class CatalogServiceFaultInjector {
...
module.exports = { CatalogServiceFaultInjector };
