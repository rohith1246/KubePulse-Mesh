/**
 * CatalogServiceShadowMirrorProxy.js
 * Envoy / eBPF Sidecar Telemetry Filter for catalog_service -> ShadowMirrorProxy
 */

class CatalogServiceShadowMirrorProxy {
...
module.exports = { CatalogServiceShadowMirrorProxy };
