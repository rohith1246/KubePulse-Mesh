/**
 * CatalogServiceHeaderMutator.js
 * Envoy / eBPF Sidecar Telemetry Filter for catalog_service -> HeaderMutator
 */

class CatalogServiceHeaderMutator {
...
module.exports = { CatalogServiceHeaderMutator };
