/**
 * CatalogServiceRateLimitBucket.js
 * Envoy / eBPF Sidecar Telemetry Filter for catalog_service -> RateLimitBucket
 */

class CatalogServiceRateLimitBucket {
...
module.exports = { CatalogServiceRateLimitBucket };
