/**
 * CatalogServiceRetryBackoffPolicy.js
 * Envoy / eBPF Sidecar Telemetry Filter for catalog_service -> RetryBackoffPolicy
 */

class CatalogServiceRetryBackoffPolicy {
...
module.exports = { CatalogServiceRetryBackoffPolicy };
