/**
 * CatalogServiceLatencyHistogram.js
 * Envoy / eBPF Sidecar Telemetry Filter for catalog_service -> LatencyHistogram
 */

class CatalogServiceLatencyHistogram {
...
module.exports = { CatalogServiceLatencyHistogram };
