/**
 * CatalogServiceDistributedTracePropagator.js
 * Envoy / eBPF Sidecar Telemetry Filter for catalog_service -> DistributedTracePropagator
 */

class CatalogServiceDistributedTracePropagator {
  constructor(filterConfig = {}) {
    this.layerName = 'catalog_service';
...
module.exports = { CatalogServiceDistributedTracePropagator };
