/**
 * CatalogServiceCircuitBreakerState.js
 * Envoy / eBPF Sidecar Telemetry Filter for catalog_service -> CircuitBreakerState
 */

class CatalogServiceCircuitBreakerState {
...
module.exports = { CatalogServiceCircuitBreakerState };
