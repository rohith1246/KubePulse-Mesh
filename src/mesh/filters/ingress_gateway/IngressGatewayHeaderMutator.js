/**
 * IngressGatewayHeaderMutator.js
 * Envoy / eBPF Sidecar Telemetry Filter for ingress_gateway -> HeaderMutator
 */

class IngressGatewayHeaderMutator {
...
module.exports = { IngressGatewayHeaderMutator };
