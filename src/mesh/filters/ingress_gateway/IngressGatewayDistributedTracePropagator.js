/**
 * IngressGatewayDistributedTracePropagator.js
 * Envoy / eBPF Sidecar Telemetry Filter for ingress_gateway -> DistributedTracePropagator
 */

class IngressGatewayDistributedTracePropagator {
  constructor(filterConfig = {}) {
    this.layerName = 'ingress_gateway';
...
module.exports = { IngressGatewayDistributedTracePropagator };
