/**
 * IngressGatewaySpiffeIdentityVerifier.js
 * Envoy / eBPF Sidecar Telemetry Filter for ingress_gateway -> SpiffeIdentityVerifier
 */

class IngressGatewaySpiffeIdentityVerifier {
...
module.exports = { IngressGatewaySpiffeIdentityVerifier };
