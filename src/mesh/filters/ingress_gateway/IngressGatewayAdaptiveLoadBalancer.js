/**
 * IngressGatewayAdaptiveLoadBalancer.js
 * Envoy / eBPF Sidecar Telemetry Filter for ingress_gateway -> AdaptiveLoadBalancer
 */

class IngressGatewayAdaptiveLoadBalancer {
...
module.exports = { IngressGatewayAdaptiveLoadBalancer };
