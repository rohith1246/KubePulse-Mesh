/**
 * IngressGatewayLatencyHistogram.js
 * Envoy / eBPF Sidecar Telemetry Filter for ingress_gateway -> LatencyHistogram
 */

class IngressGatewayLatencyHistogram {
...
module.exports = { IngressGatewayLatencyHistogram };
