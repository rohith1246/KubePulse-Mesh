/**
 * IngressGatewayRateLimitBucket.js
 * Envoy / eBPF Sidecar Telemetry Filter for ingress_gateway -> RateLimitBucket
 */

class IngressGatewayRateLimitBucket {
...
module.exports = { IngressGatewayRateLimitBucket };
