/**
 * IngressGatewayCircuitBreakerState.js
 * Envoy / eBPF Sidecar Telemetry Filter for ingress_gateway -> CircuitBreakerState
 */

class IngressGatewayCircuitBreakerState {
...
module.exports = { IngressGatewayCircuitBreakerState };
