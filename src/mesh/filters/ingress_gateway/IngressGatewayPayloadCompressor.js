/**
 * IngressGatewayPayloadCompressor.js
 * Envoy / eBPF Sidecar Telemetry Filter for ingress_gateway -> PayloadCompressor
 */

class IngressGatewayPayloadCompressor {
...
module.exports = { IngressGatewayPayloadCompressor };
