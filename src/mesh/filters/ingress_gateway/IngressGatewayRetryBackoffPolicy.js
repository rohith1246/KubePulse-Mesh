/**
 * IngressGatewayRetryBackoffPolicy.js
 * Envoy / eBPF Sidecar Telemetry Filter for ingress_gateway -> RetryBackoffPolicy
 */

class IngressGatewayRetryBackoffPolicy {
...
module.exports = { IngressGatewayRetryBackoffPolicy };
