/**
 * IngressGatewayCanaryTrafficSplitter.js
 * Envoy / eBPF Sidecar Telemetry Filter for ingress_gateway -> CanaryTrafficSplitter
 */

class IngressGatewayCanaryTrafficSplitter {
...
module.exports = { IngressGatewayCanaryTrafficSplitter };
