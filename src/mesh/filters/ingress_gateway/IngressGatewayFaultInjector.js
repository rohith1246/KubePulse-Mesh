/**
 * IngressGatewayFaultInjector.js
 * Envoy / eBPF Sidecar Telemetry Filter for ingress_gateway -> FaultInjector
 */

class IngressGatewayFaultInjector {
...
module.exports = { IngressGatewayFaultInjector };
