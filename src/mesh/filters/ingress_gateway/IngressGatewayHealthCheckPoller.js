/**
 * IngressGatewayHealthCheckPoller.js
 * Envoy / eBPF Sidecar Telemetry Filter for ingress_gateway -> HealthCheckPoller
 */

class IngressGatewayHealthCheckPoller {
...
module.exports = { IngressGatewayHealthCheckPoller };
