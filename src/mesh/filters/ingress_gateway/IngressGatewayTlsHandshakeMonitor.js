/**
 * IngressGatewayTlsHandshakeMonitor.js
 * Envoy / eBPF Sidecar Telemetry Filter for ingress_gateway -> TlsHandshakeMonitor
 */

class IngressGatewayTlsHandshakeMonitor {
...
module.exports = { IngressGatewayTlsHandshakeMonitor };
