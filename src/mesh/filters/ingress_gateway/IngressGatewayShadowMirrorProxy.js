/**
 * IngressGatewayShadowMirrorProxy.js
 * Envoy / eBPF Sidecar Telemetry Filter for ingress_gateway -> ShadowMirrorProxy
 */

class IngressGatewayShadowMirrorProxy {
...
module.exports = { IngressGatewayShadowMirrorProxy };
