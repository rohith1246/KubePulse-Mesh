/**
 * ConfigDistributorShadowMirrorProxy.js
 * Envoy / eBPF Sidecar Telemetry Filter for config_distributor -> ShadowMirrorProxy
 */

class ConfigDistributorShadowMirrorProxy {
...
module.exports = { ConfigDistributorShadowMirrorProxy };
