/**
 * ConfigDistributorAdaptiveLoadBalancer.js
 * Envoy / eBPF Sidecar Telemetry Filter for config_distributor -> AdaptiveLoadBalancer
 */

class ConfigDistributorAdaptiveLoadBalancer {
...
module.exports = { ConfigDistributorAdaptiveLoadBalancer };
