/**
 * ConfigDistributorLatencyHistogram.js
 * Envoy / eBPF Sidecar Telemetry Filter for config_distributor -> LatencyHistogram
 */

class ConfigDistributorLatencyHistogram {
...
module.exports = { ConfigDistributorLatencyHistogram };
