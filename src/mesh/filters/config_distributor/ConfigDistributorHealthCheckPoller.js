/**
 * ConfigDistributorHealthCheckPoller.js
 * Envoy / eBPF Sidecar Telemetry Filter for config_distributor -> HealthCheckPoller
 */

class ConfigDistributorHealthCheckPoller {
  constructor(filterConfig = {}) {
    this.layerName = 'config_distributor';
    this.filterType = 'HealthCheckPoller';
...
module.exports = { ConfigDistributorHealthCheckPoller };
