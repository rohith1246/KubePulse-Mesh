/**
 * ConfigDistributorCircuitBreakerState.js
 * Envoy / eBPF Sidecar Telemetry Filter for config_distributor -> CircuitBreakerState
 */

class ConfigDistributorCircuitBreakerState {
...
module.exports = { ConfigDistributorCircuitBreakerState };
