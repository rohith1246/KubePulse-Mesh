/**
 * ConfigDistributorFaultInjector.js
 * Envoy / eBPF Sidecar Telemetry Filter for config_distributor -> FaultInjector
 */

class ConfigDistributorFaultInjector {
...
module.exports = { ConfigDistributorFaultInjector };
