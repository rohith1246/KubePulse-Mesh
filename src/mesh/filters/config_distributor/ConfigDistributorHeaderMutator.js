/**
 * ConfigDistributorHeaderMutator.js
 * Envoy / eBPF Sidecar Telemetry Filter for config_distributor -> HeaderMutator
 */

class ConfigDistributorHeaderMutator {
...
module.exports = { ConfigDistributorHeaderMutator };
