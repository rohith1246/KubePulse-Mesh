/**
 * ConfigDistributorTlsHandshakeMonitor.js
 * Envoy / eBPF Sidecar Telemetry Filter for config_distributor -> TlsHandshakeMonitor
 */

class ConfigDistributorTlsHandshakeMonitor {
...
module.exports = { ConfigDistributorTlsHandshakeMonitor };
