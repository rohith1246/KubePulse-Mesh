/**
 * ConfigDistributorPayloadCompressor.js
 * Envoy / eBPF Sidecar Telemetry Filter for config_distributor -> PayloadCompressor
 */

class ConfigDistributorPayloadCompressor {
...
module.exports = { ConfigDistributorPayloadCompressor };
