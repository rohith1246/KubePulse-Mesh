/**
 * ConfigDistributorRetryBackoffPolicy.js
 * Envoy / eBPF Sidecar Telemetry Filter for config_distributor -> RetryBackoffPolicy
 */

class ConfigDistributorRetryBackoffPolicy {
...
module.exports = { ConfigDistributorRetryBackoffPolicy };
