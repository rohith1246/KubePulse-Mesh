/**
 * ConfigDistributorRateLimitBucket.js
 * Envoy / eBPF Sidecar Telemetry Filter for config_distributor -> RateLimitBucket
 */

class ConfigDistributorRateLimitBucket {
...
module.exports = { ConfigDistributorRateLimitBucket };
