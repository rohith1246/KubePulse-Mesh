/**
 * ConfigDistributorDistributedTracePropagator.js
 * Envoy / eBPF Sidecar Telemetry Filter for config_distributor -> DistributedTracePropagator
 */

class ConfigDistributorDistributedTracePropagator {
  constructor(filterConfig = {}) {
    this.layerName = 'config_distributor';
...
module.exports = { ConfigDistributorDistributedTracePropagator };
