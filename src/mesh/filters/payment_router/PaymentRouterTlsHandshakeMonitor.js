/**
 * PaymentRouterTlsHandshakeMonitor.js
 * Envoy / eBPF Sidecar Telemetry Filter for payment_router -> TlsHandshakeMonitor
 */

class PaymentRouterTlsHandshakeMonitor {
...
module.exports = { PaymentRouterTlsHandshakeMonitor };
