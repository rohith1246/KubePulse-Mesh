/**
 * PaymentRouterLatencyHistogram.js
 * Envoy / eBPF Sidecar Telemetry Filter for payment_router -> LatencyHistogram
 */

class PaymentRouterLatencyHistogram {
...
module.exports = { PaymentRouterLatencyHistogram };
