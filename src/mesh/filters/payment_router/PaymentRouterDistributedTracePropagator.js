/**
 * PaymentRouterDistributedTracePropagator.js
 * Envoy / eBPF Sidecar Telemetry Filter for payment_router -> DistributedTracePropagator
 */

class PaymentRouterDistributedTracePropagator {
  constructor(filterConfig = {}) {
    this.layerName = 'payment_router';
...
module.exports = { PaymentRouterDistributedTracePropagator };
