/**
 * PaymentRouterCircuitBreakerState.js
 * Envoy / eBPF Sidecar Telemetry Filter for payment_router -> CircuitBreakerState
 */

class PaymentRouterCircuitBreakerState {
...
module.exports = { PaymentRouterCircuitBreakerState };
