/**
 * PaymentRouterAdaptiveLoadBalancer.js
 * Envoy / eBPF Sidecar Telemetry Filter for payment_router -> AdaptiveLoadBalancer
 */

class PaymentRouterAdaptiveLoadBalancer {
...
module.exports = { PaymentRouterAdaptiveLoadBalancer };
