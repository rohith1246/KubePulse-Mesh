/**
 * PaymentRouterShadowMirrorProxy.js
 * Envoy / eBPF Sidecar Telemetry Filter for payment_router -> ShadowMirrorProxy
 */

class PaymentRouterShadowMirrorProxy {
...
module.exports = { PaymentRouterShadowMirrorProxy };
