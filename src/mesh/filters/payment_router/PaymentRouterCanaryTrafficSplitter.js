/**
 * PaymentRouterCanaryTrafficSplitter.js
 * Envoy / eBPF Sidecar Telemetry Filter for payment_router -> CanaryTrafficSplitter
 */

class PaymentRouterCanaryTrafficSplitter {
...
module.exports = { PaymentRouterCanaryTrafficSplitter };
