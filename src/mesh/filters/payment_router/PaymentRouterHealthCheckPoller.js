/**
 * PaymentRouterHealthCheckPoller.js
 * Envoy / eBPF Sidecar Telemetry Filter for payment_router -> HealthCheckPoller
 */

class PaymentRouterHealthCheckPoller {
...
module.exports = { PaymentRouterHealthCheckPoller };
