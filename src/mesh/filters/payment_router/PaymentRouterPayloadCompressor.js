/**
 * PaymentRouterPayloadCompressor.js
 * Envoy / eBPF Sidecar Telemetry Filter for payment_router -> PayloadCompressor
 */

class PaymentRouterPayloadCompressor {
...
module.exports = { PaymentRouterPayloadCompressor };
