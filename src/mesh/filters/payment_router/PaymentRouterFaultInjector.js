/**
 * PaymentRouterFaultInjector.js
 * Envoy / eBPF Sidecar Telemetry Filter for payment_router -> FaultInjector
 */

class PaymentRouterFaultInjector {
...
module.exports = { PaymentRouterFaultInjector };
