/**
 * PaymentRouterRateLimitBucket.js
 * Envoy / eBPF Sidecar Telemetry Filter for payment_router -> RateLimitBucket
 */

class PaymentRouterRateLimitBucket {
...
module.exports = { PaymentRouterRateLimitBucket };
