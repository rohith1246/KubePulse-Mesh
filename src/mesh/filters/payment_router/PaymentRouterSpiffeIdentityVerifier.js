/**
 * PaymentRouterSpiffeIdentityVerifier.js
 * Envoy / eBPF Sidecar Telemetry Filter for payment_router -> SpiffeIdentityVerifier
 */

class PaymentRouterSpiffeIdentityVerifier {
...
module.exports = { PaymentRouterSpiffeIdentityVerifier };
