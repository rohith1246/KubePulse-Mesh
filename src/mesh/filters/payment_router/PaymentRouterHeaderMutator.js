/**
 * PaymentRouterHeaderMutator.js
 * Envoy / eBPF Sidecar Telemetry Filter for payment_router -> HeaderMutator
 */

class PaymentRouterHeaderMutator {
...
module.exports = { PaymentRouterHeaderMutator };
